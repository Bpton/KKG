...
function addRowinTaxTable(taxID, TaxPercentage, TaxAmount, MRP, TaxFlag) {
    $.ajax({
        type: "POST",
        url: "/TranDepot/FillExParaInvoiceTaxDatatable",
...
function deleteRowfromTaxTable(grdproductid, grdbatchno) {
    $.ajax({
        type: "POST",
        url: "/TranDepot/DeleteTaxDatatableExParaInvoice",
...
function RowCountExParaInvoiceList() {
    var table = document.getElementById("ExParaInvoiceGrid");
    var rowCount = document.getElementById("ExParaInvoiceGrid").rows.length - 1;
    if (rowCount > 0) {
    ...
    if (returnflag == true && Taxreturnflag == true) {
        ...
        if (saveflag == true) {
            ...
            setTimeout(function () {
                ...
                freelist = new Array();
                taxlist = new Array();
                var exparainvoicesave = {};

                debugger;
                exparainvoicesave.FGInvoiceID = $('#hdndispatchID').val().trim();

                if ($('#hdndispatchID').val() == '0') {
                    exparainvoicesave.FLAG = 'A';
                }
                else {
                    exparainvoicesave.FLAG = 'U';
                }
                exparainvoicesave.InvoiceDate = $("#InvoiceDate").val().trim();
                exparainvoicesave.CUSTOMERID = $("#CUSTOMERID").val().trim();
                exparainvoicesave.CUSTOMERNAME = $("#CUSTOMERID option:selected").text().trim();
                exparainvoicesave.SaleOrderID = $("#SaleOrderID").val().trim();
                if ($("#ShippingAddress").val().trim() == '') {
                    exparainvoicesave.ShippingAddress = '';
                }
                else {
                    exparainvoicesave.ShippingAddress = $("#ShippingAddress").val().trim();
                }
                exparainvoicesave.WAYBILLNO = '0';
                exparainvoicesave.TransporterID = $("#TransporterID").val().trim();
                if ($("#VehichleNo").val().trim() == '') {
                    exparainvoicesave.VehichleNo = '';
                }
                else {
                    exparainvoicesave.VehichleNo = $("#VehichleNo").val().trim();
                }
                exparainvoicesave.BRID = $("#BRID").val().trim();
                exparainvoicesave.BRNAME = $("#BRID option:selected").text().trim();
                if ($("#LrGrNo").val().trim() == '') {
                    exparainvoicesave.LrGrNo = '';
                }
                else {
                    exparainvoicesave.LrGrNo = $("#LrGrNo").val().trim();
                }
                exparainvoicesave.LrGrDate = $("#LrGrDate").val().trim();
                if ($("#GatepassNo").val().trim() == '') {
                    exparainvoicesave.GatepassNo = '';
                }
                else {
                    exparainvoicesave.GatepassNo = $("#GatepassNo").val().trim();
                }
                exparainvoicesave.GatepassDate = $("#GatepassDate").val().trim();
                exparainvoicesave.PaymentMode = $("#PaymentMode").val().trim();
                exparainvoicesave.Tranportmode = $("#Tranportmode").val().trim();
                if ($("#Remarks").val().trim() == '') {
                    exparainvoicesave.Remarks = '';
                }
                else {
                    exparainvoicesave.Remarks = $("#Remarks").val().trim();
                }
                exparainvoicesave.NetAmt = $("#NetAmt").val().trim();
                exparainvoicesave.RoundOff = $("#RoundOff").val().trim();
                exparainvoicesave.TotalFreeAmt = $("#TotalFreeAmt").val().trim();
                exparainvoicesave.GroupID = $("#hdnGroupID").val().trim();
                exparainvoicesave.TotalPcs = $("#TotalPcs").val().trim();
                exparainvoicesave.TotalCase = $("#TotalCase").val().trim();
                if ($('#hdntaxcount').val() == '1') {
                    exparainvoicesave.InvoiceType = '1';
                }
                else if ($('#hdntaxcount').val() == '2') {
                    exparainvoicesave.InvoiceType = '2';
                }
                else if ($('#hdntaxcount').val() == '3') {
                    exparainvoicesave.InvoiceType = '3';
                }
                else {
                    exparainvoicesave.InvoiceType = '0';
                }
                if ($("#TotalGrossWght").val().trim() == '') {
                    exparainvoicesave.TotalGrossWght = '0';
                }
                else {
                    exparainvoicesave.TotalGrossWght = $("#TotalGrossWght").val().trim();
                }
                if ($("#ReferencePO").val() == '') {
                    exparainvoicesave.ReferencePO = '';
                }
                else {
                    exparainvoicesave.ReferencePO = $("#ReferencePO").val().trim();
                }

                exparainvoicesave.BasicAmt = $("#BasicAmt").val().trim();
                exparainvoicesave.MonthID = Month.trim();

                exparainvoicesave.UserID = $("#hdnUserID").val().trim();
                exparainvoicesave.FinYear = $("#hdnFinYear").val().trim();
                if (freerowCount <= 0) {
                    exparainvoicesave.GTFreeTag = '0';
                }
                else {
                    exparainvoicesave.GTFreeTag = '1';
                }
                ...
                exparainvoicesave.InvoiceDetailsGT = invoicelist;
                ...
                exparainvoicesave.FreeDetailsGT = freelist;
                ...
                exparainvoicesave.TaxDetailsGT = taxlist;

                //alert(JSON.stringify(invoicesave));

                $.ajax({
                    url: "/TranDepot/exparaInvoicesavedata",
                    data: '{exparainvoicesave:' + JSON.stringify(exparainvoicesave) + '}',
                    type: "POST",
                    async: false,
...
function ReleaseSession() {
    ...
    $.ajax({
        type: "POST",
        url: "/TranDepot/RemoveSessionExParaInvoice",
        data: '{}',
        dataType: "json",
        success: function (response) {
        }
...
function bindcpcinvoicegrid() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $('#ExParaInvoiceGrid').DataTable().destroy();
            $("#ExParaInvoiceGrid tbody tr").remove();
            for (var i = 0; i < response.length; i++) {
                ...
                tr.append("<td style='text-align: center'><input type='image' class='gvEXPARAPrint'  id='btnparaprint'  <img src='../Images/ico_Print.png' width='20' height ='20' title='Print'/></input></td>");
                tr.append("<td style='text-align: center'><input type='image' class='gvEXPARAEdit'   id='btnparaedit'   <img src='../Images/Pencil-icon.png' title='Edit'/></input></td>");
                tr.append("<td style='text-align: center'><input type='image' class='gvEXPARAView'   id='btnparaview'   <img src='../Images/View.png' width='20' height ='20' title='View'/></input></td>");
                tr.append("<td style='text-align: center'><input type='image' class='gvEXPARACancel' id='btnparadelete' <img src='../Images/ico_delete_16.png' title='Cancel'/></input></td>");

                $("#ExParaInvoiceGrid").append(tr);
            }
            tr.append("</tbody>");
            RowCountExParaInvoiceList();
            $('#ExParaInvoiceGrid').DataTable({
                "sScrollX": '100%',
                "sScrollXInner": "110%",
                "scrollY": "238px",
                "scrollCollapse": true,
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Ex-Paramilitary Invoice List'
                    }
                ],
...
$(function () {
    var invoiceid;
    $("body").on("click", "#ExParaInvoiceGrid .gvEXPARAEdit", function () {
        var row = $(this).closest("tr");
...
$(function () {
    var invoiceid;
    $("body").on("click", "#ExParaInvoiceGrid .gvEXPARAView", function () {
        var row = $(this).closest("tr");
        invoiceid = row.find('td:eq(1)').html();
        $('#hdndispatchID').val(invoiceid);
...
$(function () {
    debugger;
    var dispatchid;
    $("body").on("click", "#ExParaInvoiceGrid .gvEXPARACancel", function () {
        var row = $(this).closest("tr");
...
$(function () {
    var invoiceid;
    var acstatus = '';
    $("body").on("click", "#ExParaInvoiceGrid .gvEXPARAPrint", function () {
        var row = $(this).closest("tr");
        invoiceid = row.find('td:eq(1)').html();
        $('#hdndispatchID').val(invoiceid);
