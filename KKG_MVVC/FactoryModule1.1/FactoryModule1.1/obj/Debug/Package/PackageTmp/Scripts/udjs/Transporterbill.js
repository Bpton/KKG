...
$(document).ready(function () {
    ...
    $("body").on("click", "#gvtransporterbill .gvprint", function () {
        ...
        if (AccEntryID != '') {
            ...
            var url = "http://mcnroeerp.com:8085/FACTORY/frmRptInvoicePrint_FACv2.aspx?Stnid=" + TransporterbillID + "&TAG=TB&MenuId=45";
...
function BindTransporter() {
    ...
    $.ajax({
        type: "POST",
        url: "/Transporter/BindTransporter",
        data: { depoid: depoid},
        async: false,
        dataType: "json",
        success: function (response) {
...
function BindTransporterbyInvoice() {
    ...
    $.ajax({
        type: "POST",
        url: "/Transporter/BindTransporterbyInvoice",
...
function BindAllInvoicenoNEWV2() {
    ...
    $.ajax({
        type: "POST",
        url: "/Transporter/BindAllInvoicenoNEWV2",
        data: { tag: tag, depoid: depoid, transporterbillid: transporterbillid},
        async: false,
        dataType: "json",
        success: function (response) {
            //alert(JSON.stringify(response));
...
function BindGstPercentage() {
    ...
    $.ajax({
        ...
        data: {
            depoid: depoid, tranporterid: tranporterid, bvalue: bvalue, InvoiceId: InvoiceId, BillingType: BillingType, Fromstate: Fromstate, Tostate: Tostate},
        async: false,
        dataType: "json",
        success: function (response) {
            var cgstid;
...
function chklrgrno(TAG, transporterID, LRGRNO, TRANSPORETERBILLID, INVID) {
    ...
    $.ajax({
        ...
        data: { TAG: TAG, transporterID: transporterID, LRGRNO: LRGRNO, TRANSPORETERBILLID: TRANSPORETERBILLID, INVID: INVID},
        async: false,
        dataType: "json",
        success: function (response) {
...
function TDSPercentage(tranporterid, bvalue) {
    ...
    $.ajax({
        ...
        data: { tranporterid: tranporterid, bvalue: bvalue },
        async: false,
        dataType: "json",
        success: function (response) {
            ...
            if (tdspercent |= '0') {
                ...
                tdsvalue = (parseFloat(bvalue) * parseFloat(tdspercent)) / 100;
                $("#txtsumtds").val(tdsvalue);
                netamt = parseFloat($("#txtsumnetamt").val())-tdsvalue;
...
function SaveTransporterbillV2fac() {
    ...
    $.ajax({
        ...
        url: "/Transporter/SaveTransporterbillV2fac",
...
function BindTransporterbillall() {
    ...
    $.ajax({
        ...
        url: "/Transporter/BindTransporterbillall",

        // data: "{'FromDate': '" + FromDate + "', 'ToDate': '" + ToDate + "','VoucherID': '" + VoucherID + "','DepotID': '" + DepotID + "','checker': '" + checker + "'}",
        data: { fromData: fromData, ToDate: ToDate, depotid: depotid, },
