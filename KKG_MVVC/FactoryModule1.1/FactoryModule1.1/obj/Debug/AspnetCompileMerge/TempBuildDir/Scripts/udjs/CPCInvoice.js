...
function addRowinTaxTable(taxID, TaxPercentage, TaxAmount, MRP, TaxFlag) {
    $.ajax({
        type: "POST",
        url: "/TranDepot/FillCPCInvoiceTaxDatatable",
...
function deleteRowfromTaxTable(grdproductid, grdbatchno) {
    $.ajax({
        type: "POST",
        url: "/TranDepot/DeleteTaxDatatableCPCInvoice",
...
function RowCountCpcInvoiceList() {
    var table = document.getElementById("CPCInvoiceGrid");
    var rowCount = document.getElementById("CPCInvoiceGrid").rows.length - 1;
    if (rowCount > 0) {
    ...
    if (returnflag == true && Taxreturnflag == true) {
        ...
        if (saveflag == true) {
            ...
            setTimeout(function () {
                ...
                debugger;
                cpcinvoicesave.FGInvoiceID = $('#hdndispatchID').val().trim();

                if ($('#hdndispatchID').val() == '0') {
                    cpcinvoicesave.FLAG = 'A';
                }
                else {
                    cpcinvoicesave.FLAG = 'U';
                }
                cpcinvoicesave.InvoiceDate = $("#InvoiceDate").val().trim();
                cpcinvoicesave.CUSTOMERID = $("#CUSTOMERID").val().trim();
                cpcinvoicesave.CUSTOMERNAME = $("#CUSTOMERID option:selected").text().trim();
                cpcinvoicesave.SaleOrderID = $("#SaleOrderID").val().trim();
                if ($("#ShippingAddress").val().trim() == '') {
                    cpcinvoicesave.ShippingAddress = '';
                }
                else {
                    cpcinvoicesave.ShippingAddress = $("#ShippingAddress").val().trim();
                }
                cpcinvoicesave.WAYBILLNO = '0';
                cpcinvoicesave.TransporterID = $("#TransporterID").val().trim();
                if ($("#VehichleNo").val().trim() == '') {
                    cpcinvoicesave.VehichleNo = '';
                }
                else {
                    cpcinvoicesave.VehichleNo = $("#VehichleNo").val().trim();
                }
                cpcinvoicesave.BRID = $("#BRID").val().trim();
                cpcinvoicesave.BRNAME = $("#BRID option:selected").text().trim();
                if ($("#LrGrNo").val().trim() == '') {
                    cpcinvoicesave.LrGrNo = '';
                }
                else {
                    cpcinvoicesave.LrGrNo = $("#LrGrNo").val().trim();
                }
                cpcinvoicesave.LrGrDate = $("#LrGrDate").val().trim();
                if ($("#GatepassNo").val().trim() == '') {
                    cpcinvoicesave.GatepassNo = '';
                }
                else {
                    cpcinvoicesave.GatepassNo = $("#GatepassNo").val().trim();
                }
                cpcinvoicesave.GatepassDate = $("#GatepassDate").val().trim();
                cpcinvoicesave.PaymentMode = $("#PaymentMode").val().trim();
                cpcinvoicesave.Tranportmode = $("#Tranportmode").val().trim();
                if ($("#Remarks").val().trim() == '') {
                    cpcinvoicesave.Remarks = '';
                }
                else {
                    cpcinvoicesave.Remarks = $("#Remarks").val().trim();
                }
                cpcinvoicesave.NetAmt = $("#NetAmt").val().trim();
                cpcinvoicesave.RoundOff = $("#RoundOff").val().trim();
                cpcinvoicesave.TotalFreeAmt = $("#TotalFreeAmt").val().trim();
                cpcinvoicesave.GroupID = $("#hdnGroupID").val().trim();
                cpcinvoicesave.TotalPcs = $("#TotalPcs").val().trim();
                cpcinvoicesave.TotalCase = $("#TotalCase").val().trim();
                if ($('#hdntaxcount').val() == '1') {
                    cpcinvoicesave.InvoiceType = '1';
                }
                else if ($('#hdntaxcount').val() == '2') {
                    cpcinvoicesave.InvoiceType = '2';
                }
                else if ($('#hdntaxcount').val() == '3') {
                    cpcinvoicesave.InvoiceType = '3';
                }
                else {
                    cpcinvoicesave.InvoiceType = '0';
                }
                if ($("#TotalGrossWght").val().trim() == '') {
                    cpcinvoicesave.TotalGrossWght = '0';
                }
                else {
                    cpcinvoicesave.TotalGrossWght = $("#TotalGrossWght").val().trim();
                }
                if ($("#ReferencePO").val() == '') {
                    cpcinvoicesave.ReferencePO = '';
                }
                else {
                    cpcinvoicesave.ReferencePO = $("#ReferencePO").val().trim();
                }

                cpcinvoicesave.BasicAmt = $("#BasicAmt").val().trim();
                cpcinvoicesave.MonthID = Month.trim();

                cpcinvoicesave.UserID = $("#hdnUserID").val().trim();
                cpcinvoicesave.FinYear = $("#hdnFinYear").val().trim();
                if (freerowCount <= 0) {
                    cpcinvoicesave.GTFreeTag = '0';
                }
                else {
                    cpcinvoicesave.GTFreeTag = '1';
                }
                ...
                cpcinvoicesave.InvoiceDetailsGT = invoicelist;
                ...
                cpcinvoicesave.FreeDetailsGT = freelist;
                ...
                cpcinvoicesave.TaxDetailsGT = taxlist;

                //alert(JSON.stringify(invoicesave));

                $.ajax({
                    url: "/TranDepot/cpcInvoicesavedata",
                    data: '{cpcinvoicesave:' + JSON.stringify(cpcinvoicesave) + '}',
                    type: "POST",
                    async: false,
...
function ReleaseSession() {
    ...
    $.ajax({
        type: "POST",
        url: "/TranDepot/RemoveSessionCPCInvoice",
        data: '{}',
        dataType: "json",
        success: function (response) {
        }
...
function bindcpcinvoicegrid() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $('#CPCInvoiceGrid').DataTable().destroy();
            $("#CPCInvoiceGrid tbody tr").remove();
            for (var i = 0; i < response.length; i++) {
                ...
                tr.append("<td style='text-align: center'><input type='image' class='gvCPCPrint'  id='btncpcprint'  <img src='../Images/ico_Print.png' width='20' height ='20' title='Print'/></input></td>");
                tr.append("<td style='text-align: center'><input type='image' class='gvCPCEdit'   id='btncpcedit'   <img src='../Images/Pencil-icon.png' title='Edit'/></input></td>");
                tr.append("<td style='text-align: center'><input type='image' class='gvCPCView'   id='btncpcview'   <img src='../Images/View.png' width='20' height ='20' title='View'/></input></td>");
                tr.append("<td style='text-align: center'><input type='image' class='gvCPCCancel' id='btncpcdelete' <img src='../Images/ico_delete_16.png' title='Cancel'/></input></td>");

                $("#CPCInvoiceGrid").append(tr);
            }
            tr.append("</tbody>");
            RowCountCpcInvoiceList();
            $('#CPCInvoiceGrid').DataTable({
                "sScrollX": '100%',
                "sScrollXInner": "110%",
                "scrollY": "238px",
                "scrollCollapse": true,
...
$(function () {
    var invoiceid;
    $("body").on("click", "#CPCInvoiceGrid .gvCPCEdit", function () {
        var row = $(this).closest("tr");
...
$(function () {
    var invoiceid;
    $("body").on("click", "#CPCInvoiceGrid .gvCPCView", function () {
        var row = $(this).closest("tr");
        invoiceid = row.find('td:eq(1)').html();
        $('#hdndispatchID').val(invoiceid);
...
$(function () {
    debugger;
    var dispatchid;
    $("body").on("click", "#CPCInvoiceGrid .gvCPCCancel", function () {
        var row = $(this).closest("tr");
...
$(function () {
    var invoiceid;
    var acstatus = '';
    $("body").on("click", "#CPCInvoiceGrid .gvCPCPrint", function () {
        var row = $(this).closest("tr");
        invoiceid = row.find('td:eq(1)').html();
        $('#hdndispatchID').val(invoiceid);
