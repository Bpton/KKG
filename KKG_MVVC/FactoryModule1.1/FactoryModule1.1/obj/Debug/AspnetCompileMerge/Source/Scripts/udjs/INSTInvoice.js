    ...
    $('#SaleOrderID').change(function (e) {
        ...
        setTimeout(function () {
            ...
            if ($('#SaleOrderID').val() != '0') {
                debugger;
                bindMTProduct($('#SaleOrderID').val().trim());
...
function bindMTProduct(saleorderid) {
...
function PriceScheme(productID, productname, batchno, packsizeid, packsizename, frompacksizeID,
    ...
    remainingqty = parseInt($("#hdnOrderqtyPcs").val()) - (parseInt($("#hdnFinalDeliveredqtyPcs").val()) + parseInt(totalqty));
        ...
        success: function (response) {
            ...
            if (customerlength == 1) {
                ...
                $.each(response, function () {
                    ...
                    //CustomerTargetDetails(CustomerID.trim(), $('#BRID').val().trim(), BusinessSegment, Month, $('#hdndispatchID').val().trim(), $('#hdnFinYear').val().trim());
        ...
        success: function (response) {
            ...
            if (orderlength == 1) {
                ...
                $.each(response, function () {
                    ...
                    bindMTProduct(SaleorderID.trim());
...
function bindorderdetails(orderid, productid, packsizeid, invoiceid) {
    ...
    remainingqty = parseInt(orderqtypcs) - (parseInt(finaldeliveredqty) + parseInt(totalqty));
    $("#RemainingQty").val(parseInt(remainingqty));
...
function addRowinTaxTable(taxID, TaxPercentage, TaxAmount, MRP, TaxFlag) {
    $.ajax({
        type: "POST",
        url: "/TranDepot/FillINSTInvoiceTaxDatatable",
...
function deleteRowfromTaxTable(grdproductid, grdbatchno) {
    $.ajax({
        type: "POST",
        url: "/TranDepot/DeleteTaxDatatableINSTInvoice",
...
function RowCountMtInvoiceList() {
    var table = document.getElementById("MTInvoiceGrid");
    var rowCount = document.getElementById("MTInvoiceGrid").rows.length - 1;
    if (rowCount > 0) {
...
function SaveInvoice() {
    ...
    if (returnflag == true && Taxreturnflag == true) {
        ...
        grpstatus = getGroupStatus($("#CUSTOMERID").val().trim(), BusinessSegment.trim());
        ...
        if (saveflag == true) {
            ...
            setTimeout(function () {
                ...
                debugger;
                mtinvoicesave.FGInvoiceID = $('#hdndispatchID').val().trim();

                if ($('#hdndispatchID').val() == '0') {
                    mtinvoicesave.FLAG = 'A';
                }
                else {
                    mtinvoicesave.FLAG = 'U';
                }
                mtinvoicesave.InvoiceDate = $("#InvoiceDate").val().trim();
                mtinvoicesave.CUSTOMERID = $("#CUSTOMERID").val().trim();
                mtinvoicesave.CUSTOMERNAME = $("#CUSTOMERID option:selected").text().trim();
                mtinvoicesave.SaleOrderID = $("#SaleOrderID").val().trim();
                if ($("#ShippingAddress").val().trim() == '') {
                    mtinvoicesave.ShippingAddress = '';
                }
                else {
                    mtinvoicesave.ShippingAddress = $("#ShippingAddress").val().trim();
                }
                mtinvoicesave.WAYBILLNO = '0';
                mtinvoicesave.TransporterID = $("#TransporterID").val().trim();
                if ($("#VehichleNo").val().trim() == '') {
                    mtinvoicesave.VehichleNo = '';
                }
                else {
                    mtinvoicesave.VehichleNo = $("#VehichleNo").val().trim();
                }
                mtinvoicesave.BRID = $("#BRID").val().trim();
                mtinvoicesave.BRNAME = $("#BRID option:selected").text().trim();
                if ($("#LrGrNo").val().trim() == '') {
                    mtinvoicesave.LrGrNo = '';
                }
                else {
                    mtinvoicesave.LrGrNo = $("#LrGrNo").val().trim();
                }
                mtinvoicesave.LrGrDate = $("#LrGrDate").val().trim();
                if ($("#GatepassNo").val().trim() == '') {
                    mtinvoicesave.GatepassNo = '';
                }
                else {
                    mtinvoicesave.GatepassNo = $("#GatepassNo").val().trim();
                }
                mtinvoicesave.GatepassDate = $("#GatepassDate").val().trim();
                mtinvoicesave.PaymentMode = $("#PaymentMode").val().trim();
                mtinvoicesave.Tranportmode = $("#Tranportmode").val().trim();
                if ($("#Remarks").val().trim() == '') {
                    mtinvoicesave.Remarks = '';
                }
                else {
                    mtinvoicesave.Remarks = $("#Remarks").val().trim();
                }
                mtinvoicesave.NetAmt = $("#NetAmt").val().trim();
                mtinvoicesave.RoundOff = $("#RoundOff").val().trim();
                mtinvoicesave.TotalFreeAmt = $("#TotalFreeAmt").val().trim();
                mtinvoicesave.GroupID = $("#hdnGroupID").val().trim();
                mtinvoicesave.TotalPcs = $("#TotalPcs").val().trim();
                mtinvoicesave.TotalCase = $("#TotalCase").val().trim();
                if ($('#hdntaxcount').val() == '1') {
                    mtinvoicesave.InvoiceType = '1';
                }
                else if ($('#hdntaxcount').val() == '2') {
                    mtinvoicesave.InvoiceType = '2';
                }
                else if ($('#hdntaxcount').val() == '3') {
                    mtinvoicesave.InvoiceType = '3';
                }
                else {
                    mtinvoicesave.InvoiceType = '0';
                }
                if ($("#TotalGrossWght").val().trim() == '') {
                    mtinvoicesave.TotalGrossWght = '0';
                }
                else {
                    mtinvoicesave.TotalGrossWght = $("#TotalGrossWght").val().trim();
                }
                if ($("#ReferencePO").val() == '') {
                    mtinvoicesave.ReferencePO = '';
                }
                else {
                    mtinvoicesave.ReferencePO = $("#ReferencePO").val().trim();
                }

                mtinvoicesave.BasicAmt = $("#BasicAmt").val().trim();
                mtinvoicesave.MonthID = Month.trim();

                mtinvoicesave.UserID = $("#hdnUserID").val().trim();
                mtinvoicesave.FinYear = $("#hdnFinYear").val().trim();
                if (freerowCount <= 0) {
                    mtinvoicesave.GTFreeTag = '0';
                }
                else {
                    mtinvoicesave.GTFreeTag = '1';
                }

                /*TCS Controls*/
                mtinvoicesave.TCSPercent = $("#TCSPercent").val().trim();
                mtinvoicesave.TCSAmt = $("#TCSAmt").val().trim();
                mtinvoicesave.TCSNetAmt = $("#TCSNetAmt").val().trim();
                ...
                mtinvoicesave.InvoiceDetailsGT = invoicelist;
                ...
                mtinvoicesave.FreeDetailsGT = freelist;
                ...
                mtinvoicesave.TaxDetailsGT = taxlist;

                //alert(JSON.stringify(invoicesave));

                $.ajax({
                    url: "/TranDepot/instInvoicesavedata",
                    data: '{instinvoicesave:' + JSON.stringify(mtinvoicesave) + '}',
                    type: "POST",
                    async: false,
...
function ReleaseSession() {
    ...
    $.ajax({
        type: "POST",
        url: "/TranDepot/RemoveSessionINSTInvoice",
        data: '{}',
        dataType: "json",
        success: function (response) {
        }
...
function bindmtinvoicegrid() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $('#MTInvoiceGrid').DataTable().destroy();
            $("#MTInvoiceGrid tbody tr").remove();
            for (var i = 0; i < response.length; i++) {
                ...
                tr.append("<td style='text-align: center'><input type='image' class='gvMTPrint'  id='btnmtprint'  <img src='../Images/ico_Print.png' width='20' height ='20' title='Print'/></input></td>");
                tr.append("<td style='text-align: center'><input type='image' class='gvMTEdit'   id='btnmtedit'   <img src='../Images/Pencil-icon.png' title='Edit'/></input></td>");
                tr.append("<td style='text-align: center'><input type='image' class='gvMTView'   id='btnmtview'   <img src='../Images/View.png' width='20' height ='20' title='View'/></input></td>");
                tr.append("<td style='text-align: center'><input type='image' class='gvMTCancel' id='btnmtdelete' <img src='../Images/ico_delete_16.png' title='Cancel'/></input></td>");

                $("#MTInvoiceGrid").append(tr);
            }
            tr.append("</tbody>");
            RowCountMtInvoiceList();
            $('#MTInvoiceGrid').DataTable({
                "sScrollX": '100%',
                "sScrollXInner": "110%",
                "scrollY": "238px",
                "scrollCollapse": true,
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Institutional Invoice List'
                    }
                ],
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $.each(listOrderHeader, function (index, record) {
                ...
                Saleorder.append($("<option></option>").val(this['SALEORDERID']).html(this['REFSALEORDERNO']));
            });
            $("#SaleOrderID").trigger("liszt:updated");

            /*Bind Product*/
            bindMTProduct(OrderID.trim());
...
$(function () {
    var invoiceid;
    $("body").on("click", "#MTInvoiceGrid .gvMTEdit", function () {
        var row = $(this).closest("tr");
...
$(function () {
    var invoiceid;
    $("body").on("click", "#MTInvoiceGrid .gvMTView", function () {
        var row = $(this).closest("tr");
        invoiceid = row.find('td:eq(1)').html();
        $('#hdndispatchID').val(invoiceid);
...
$(function () {
    debugger;
    var dispatchid;
    $("body").on("click", "#MTInvoiceGrid .gvMTCancel", function () {
        var row = $(this).closest("tr");
...
$(function () {
    ...
    $("body").on("click", "#MTInvoiceGrid .gvMTPrint", function () {
        var row = $(this).closest("tr");
        invoiceid = row.find('td:eq(1)').html();
        $('#hdndispatchID').val(invoiceid);
        $("#dialog").dialog({
