...
function addRowinTaxTable(taxID, TaxPercentage, TaxAmount, MRP, TaxFlag) {
    $.ajax({
        type: "POST",
        url: "/TranDepot/FillMTInvoiceTaxDatatable",
...
function deleteRowfromTaxTable(grdproductid, grdbatchno) {
    $.ajax({
        type: "POST",
        url: "/TranDepot/DeleteTaxDatatableMTInvoice",
    ...
    if (returnflag == true && Taxreturnflag == true) {
        ...
        if (saveflag == true) {
            ...
            setTimeout(function () {
                ...
                $.ajax({
                    url: "/TranDepot/mtInvoicesavedata",
                    data: '{mtinvoicesave:' + JSON.stringify(mtinvoicesave) + '}',
                    type: "POST",
                    async: false,
...
function ReleaseSession() {
    ...
    $.ajax({
        type: "POST",
        url: "/TranDepot/RemoveSessionMTInvoice",
        data: '{}',
        dataType: "json",
        success: function (response) {
        }
