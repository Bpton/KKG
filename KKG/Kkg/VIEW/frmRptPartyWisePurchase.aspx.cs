...
public partial class FACTORY_frmRptPartyWisePurchase : System.Web.UI.Page
{
    ...
    protected void BindGrid()
    {
        ...
        dtDisplayGrid = clsrpt.BIND_PARTYWISE_PURCHASE(this.txtfromdate.Text.Trim(), this.txttodate.Text.Trim(), DepotID.Trim(), CATID, PRODUCTID, TYPEID, SearchTag, TSID, Session["FINYEAR"].ToString());
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Product&PartyWise Purchase.xls");
            Response.Charset = "";
            ...
            hw.Write("<table><tr><td colspan='3'>Product & Party Wise Purchase Report</ td></tr>");
