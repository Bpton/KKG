...
using Utility;
public partial class VIEW_frmPOFileUpload_FAC : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(Request.QueryString["POID"].ToString().Trim()))
                {
    ...
    public void LoadUploadGrid()
    {
        try
        {
            ...
            DataTable fileList = clspo.GetPurchaseorderFile(Session["POID"].ToString());
    ...
    public void LoadPoDocument()/*quation*/
    {
        try
        {
            ...
            DataTable fileList = clsqc.GetPoFile(Session["POID"].ToString());
            Session["UPLOADFILENAME"] = fileList;
            gvFiles.DataSource = fileList;
            gvFiles.DataBind();
        }
    ...
    public void LoadPoComDocument()/*comprative*/
    {
        ...
        {
            ClsMMPPQualityControl clsqc = new ClsMMPPQualityControl();
            DataTable fileList = clsqc.GetPurchaseorderFile(Session["POID"].ToString());
            Session["UPLOADFILENAME"] = fileList;
            gvFiles.DataSource = fileList;
            gvFiles.DataBind();
        }
