<%@ Page Title="" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true" CodeFile="frmRptConsolidatedTrialBalance.aspx.cs" Inherits="VIEW_frmRptConsolidatedTrialBalance" %>
                    ...
                    <div class="grid_12">
                        <div class="widget_wrap">
                            <div class="widget_top active" id="trBtn" runat="server">
                                ...
                                <h6>
                                    <asp:Label ID="lbltype" runat="server" Text="Consolidated Trial Balance"></asp:Label>
                                </h6>
                            </div>
                                ...
                                <asp:Panel ID="pnlDisplay" runat="server">
                                            ...
                                            <td>
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        ...
                                                        <td class="field_input" width="320" style="display:none">
                                    ...
                                    <div class="gridcontent">
                                        ...
                                        <div style="overflow: scroll; margin-bottom: 8px; margin-right:6px;" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                            <asp:GridView ID="grdledger" runat="server" Width="100%" AutoGenerateColumns="false" OnRowDataBound="grdledger_RowDataBound" OnDataBound="grdledger_OnDataBound"
                                                ...
                                                <%--<Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="DEDIT" ItemStyle-HorizontalAlign="Right">
                                                        <ItemTemplate>
