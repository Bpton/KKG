<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmQCCOAFileDownload_FAC.aspx.cs" Inherits="VIEW_frmQCCOAFileDownload_FAC" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="contentarea">
            <fieldset style="border-color: #0000FF; border-style: double">
                <legend>Quality Control Documents Download</legend>
                <table cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                    <tr>
                        ...
                        <td width="100" runat="server" id="lbluploadbtn" >
