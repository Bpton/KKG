<%@ Page Title="" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true"
    CodeFile="frmRptPoStatusReport.aspx.cs" Inherits="FACTORY_frmRptPoStatusReport" %>
                            ...
                            <div class="widget_content">
                                <asp:Panel ID="pnlDisplay" runat="server">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                                        ...
                                        <tr> 
                                             <td class="field_title" width="150">
                                                <asp:Label ID="Label4" runat="server" Text="DEPOT"></asp:Label>
                                            </td>
                                            <td class="field_input" width="100">
                                                <asp:DropDownList ID="ddldepot" runat="server" AppendDataBoundItems="True" Width="160"
                                                    Height="28" class="chosen-select" data-placeholder="Choose">                                                   
                                                </asp:DropDownList>
                                            </td>
