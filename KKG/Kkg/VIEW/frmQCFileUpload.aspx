<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmQCFileUpload.aspx.cs" Inherits="VIEW_frmQCFileUpload" %>
...
<body bgcolor="#eee">
    ...
    <div id="contentarea">
      <table width="98%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
      <tr>
        <td>
        <fieldset>
                                    ...
                                    <asp:GridView ID="gvFiles" runat="server" AutoGenerateColumns="False" EmptyDataText="No files uploaded"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Delete">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkDelete" ToolTip="Delete" class="action-icons c-delete"
