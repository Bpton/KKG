<%@ Page Title="" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true" CodeFile="frmChequeBookletCancel.aspx.cs" Inherits="VIEW_frmChequeBookletCancel" %>
                            ...
                            <div class="widget_content">
                               <%-- <asp:Panel ID="pnlADD" runat="server">--%>
                                 ...
                                 <%--   <div class="gridcontent-inner" id="trvoucher" runat="server">--%>
                                        <fieldset>
                                            <legend>CHEQUE BOOK DETAILS</legend>
                                        ...
                                        <tr>
                                            <td class="field_input" style="padding-left: 10px; width:50%;">
                                                <div class="btn_24_green" id="divbtnapprove" runat="server">
                                                    ...
                                                    <asp:LinkButton ID="btnApprove" runat="server" Text="Cancel" CssClass="btn_link"
                                                        CausesValidation="false" OnClick="btnApprove_Click" OnClientClick="return confirm('Are you sure you want to Cancel above Cheque?')" />
                                                </div>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
