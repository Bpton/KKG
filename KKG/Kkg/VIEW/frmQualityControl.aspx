<%@ Page Title="" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true"
    CodeFile="frmQualityControl.aspx.cs" Inherits="VIEW_frmQualityControl" %>
                                            ...
                                            <td class="field_input" style="padding-left: 10px;">
                                                <fieldset>
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                        <tr id="trQaDate" runat="server">
                                                            <td width="110" class="innerfield_title" style="padding-left: 10px;">
                                                                <asp:Label ID="lblQaDate" runat="server" Text="Qa Date"></asp:Label><span class="req">*</span>
                                                            </td>
                                                            <td width="145">
                                                                <asp:TextBox ID="txtQaDate" runat="server" Width="100" Enabled="false" placeholder="dd/mm/yyyy"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="90" class="innerfield_title" style="padding-left: 10px;">
                                                                <asp:Label ID="Label3" runat="server" Text="QC. Ref No"></asp:Label>
                                                            </td>
                                                            <td width="135">
                                        ...
                                        <tr id="trproductdetails" runat="server">
                                            <td class="field_input" style="padding-left: 10px;">
                                                <fieldset>
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            <td width="110" class="innerfield_title" style="padding-left: 4px; padding-bottom: 4px;">
                                                                <asp:Label ID="Label6" runat="server" Text="Product Type"></asp:Label>
                                                            </td>
                                                             <td colspan="1" style="padding-bottom: 4px;">
                                                            <asp:RadioButtonList id="rdbProductFrom" AutoPostBack="true" OnSelectedIndexChanged="rdbProductFrom_SelectedIndexChanged" runat="server">
                                                              <asp:ListItem Selected="True" Value="P">With Out Bom</asp:ListItem>
                                                              <asp:ListItem Value="B">With Bom</asp:ListItem>
                                                           </asp:RadioButtonList>
                                                                 </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="70" class="field_title" style="padding-bottom: 12px;">
                                                                <asp:Label ID="Label10" runat="server" Text="Order No"></asp:Label>
                                                                <span class="req">*</span>
                                                            </td>
                                                            <td class="field_input" style="padding-bottom: 14px;">
                                                                <asp:DropDownList ID="ddlponoNew" runat="server" Width="200" class="chosen-select"
                                                                    AutoPostBack="true" OnSelectedIndexChanged="ddlponoNew_SelectedIndexChanged">
                                                                    <asp:ListItem Text="SELECT Order NO" Value="0"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                    </table>
                                        ...
                                        <fieldset>
                                            ...
                                            <cc1:Grid ID="gvqcentry" runat="server" CallbackMode="true" AllowAddingRecords="false" EnableRecordHover="true"
                                                ...
                                                <Columns>
                                                    ...
                                                    <cc1:Column ID="Column27" DataField="BATCHNO" HeaderText="BATCH NO" runat="server" Visible="false"
                                                        Width="120" Wrap="true">
                                                    </cc1:Column>
                                                    ...
                                                    <cc1:Column ID="Column3" DataField="" HeaderText="ACCEPTED QC QTY" runat="server"
                                                        AllowEdit="true" Wrap="true" Width="110">
                                                        <TemplateSettings TemplateId="CurrentQCQty" />
                                                    </cc1:Column>
                                                    <cc1:Column ID="Column36" DataField="" HeaderText="REJECTED QC QTY" runat="server"
                                                        AllowEdit="true" Wrap="true" Width="110">
                                                    ...
                                                    <cc1:Column DataField="REASONNAME" HeaderText="REJECTED QC QTY REASON" Width="180" AllowEdit="true"
                                                        Wrap="true">
                                                    ...
                                                    <cc1:Column ID="Column31" DataField="PUID" HeaderText="PUID" runat="server" Visible="false" />
                                                       <cc1:Column ID="Column201" DataField="ALREADYREJECTQTY" HeaderText="ALREADY REJECTQTY" runat="server"
                                                        Wrap="true" Width="100">
                                                    </cc1:Column>
                                                </Columns>
                                                <Templates>
                                                    ...
                                                    <cc1:GridTemplate runat="server" ID="tempReason" ControlID="ddlreason">
                                                        <Template>
                                                           <%-- <asp:DropDownList ID="ddlreason" runat="server" Width="100%" Height="18" CssClass="MyDDL"
                                                             ...
                                                             <asp:TextBox runat="server" ID="txtreason" MaxLength="50" Width="180" />
                                    ...
                                    <div class="gridcontent-inner">
                                        <fieldset>
                                            ...
                                            <cc1:Grid ID="gvQCUpdate" runat="server" CallbackMode="true" AllowAddingRecords="false" EnableRecordHover="true"
                                                ...
                                                OnRowDataBound="gvQCUpdate_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <cc1:Column ID="Column9" DataField="PRODUCTID" ReadOnly="true" HeaderText="ID" runat="server"
                                                        Visible="false" />
                                                    <cc1:Column ID="Column10" DataField="Sl" HeaderText="SL" runat="server" Width="40">
                                                        <TemplateSettings TemplateId="slnoTemplateqc" />
                                                    </cc1:Column>
                                                    <cc1:Column ID="Column17" DataField="PONO" HeaderText="PO NO" runat="server" Width="70"
                                                        Wrap="true" />
                                                    ...
                                                    <cc1:Column ID="Column26" DataField="BATCHNO" HeaderText="BATCH NO" runat="server" Visible="false"
                                                        Width="140" Wrap="true">
                                                    </cc1:Column>
                                                    <cc1:Column ID="Column13" DataField="PRODUCTIONQTY" HeaderText="PRODUCTION QTY" runat="server"
                                                        Wrap="true" Width="120">
                                                    </cc1:Column>                                                    
                                                    <cc1:Column ID="Column15" DataField="CURRENTQCQTY" HeaderText="ACCEPTED QC QTY"
                                                        runat="server" Wrap="true" Width="110">
                                                    </cc1:Column>
                                                    <cc1:Column ID="Column37" DataField="REJECTEDQCQTY" HeaderText="REJECTED QC QTY"
                                                        runat="server" Wrap="true" Width="110">
                                                    </cc1:Column>

                                                    <cc1:Column ID="Column14" DataField="ALREADYQCQTY" HeaderText="QA QTY" runat="server" Wrap="true" Width="80">                                                        
                                                    </cc1:Column>

                                                      <cc1:Column ID="Column45" HeaderText="ACCEPTED QA QTY" runat="server" Wrap="true" Width="80" AllowEdit="true">
                                                          <TemplateSettings TemplateId="tempAcceptedQaQty" />
                                                    </cc1:Column>

                                                    <cc1:Column ID="Column46" HeaderText="REJECTED QA QTY" runat="server" Wrap="true" Width="80" AllowEdit="true">
                                                        <TemplateSettings TemplateId="tempRejectedQaQty" />
                                                    </cc1:Column>

                                                    <cc1:Column ID="Column19" DataField="REMAININGQCQTY" HeaderText="REMAINIG QTY" runat="server"
                                                        Wrap="true" Width="100" Visible="false">
                                                    </cc1:Column>
                                                    <cc1:Column ID="Column33" DataField="TOTALQCQTY" HeaderText="TOTAL QTY" runat="server" Visible="false"
                                                        Wrap="true" Width="100">
                                                    </cc1:Column>
                                                    <cc1:Column ID="Column16" DataField="PACKINGSIZENAME" HeaderText="PACK SIZE" runat="server"
                                                        Width="120" Wrap="true">
                                                    </cc1:Column>
                                                    <cc1:Column ID="Column34" DataField="REASONNAME" HeaderText="REJECTED QC QTY REASON"
                                                        runat="server" Width="200" Wrap="true">
                                                    </cc1:Column>

                                                    <cc1:Column ID="Column47" HeaderText="REJECTED QA QTY REASON" runat="server" Width="200" Wrap="true" AllowEdit="true">
                                                        <TemplateSettings TemplateId="tempRejectedQaReason" />
                                                    </cc1:Column>
                                                ...
                                                <Templates>
                                                    <cc1:GridTemplate runat="server" ID="tempAcceptedQaQty">
                                                        <Template>
                                                            <asp:HiddenField runat="server" ID="QCACCEPTEDQAQTYGUID" Value='<%# Container.DataItem["PRODUCTNAME"] %>' />
                                                            <asp:TextBox runat="server" ID="txtacceptedqaqty" MaxLength="10" Width="120" 
                                                                Text='<%# Container.DataItem["ACCEPTEDQAQTY"] %>'
                                                                Height="18" onkeypress="return isNumberKeyWithDot(event);" AutoCompleteType="Disabled"
                                                                onfocus="disableautocompletion(this.id);"></asp:TextBox>
                                                        </Template>
                                                    </cc1:GridTemplate>

                                                     <cc1:GridTemplate runat="server" ID="tempRejectedQaQty">
                                                        <Template>
                                                            <asp:HiddenField runat="server" ID="QCREJECTEDQAQTYGUID" Value='<%# Container.DataItem["PRODUCTNAME"] %>' />
                                                            <asp:TextBox runat="server" ID="txtrejectedqaqty" MaxLength="10" Width="120"
                                                                Text='<%# Container.DataItem["REJECTEDQAQTY"] %>'
                                                                Height="18" onkeypress="return isNumberKeyWithDot(event);" AutoCompleteType="Disabled" AutoPostBack="true"
                                                                OnTextChanged="txtrejectedqaqty_TextChanged"
                                                                onfocus="disableautocompletion(this.id);" />
                                                        </Template>
                                                    </cc1:GridTemplate>

                                                    <cc1:GridTemplate runat="server" ID="tempRejectedQaReason">
                                                        <Template>
                                                             <asp:TextBox runat="server" ID="txtRejectedQaReason" Text='<%# Container.DataItem["REJECTEDQAREASON"] %>' 
                                                                 MaxLength="50" Width="180" />
                                                        </Template>
                                                    </cc1:GridTemplate>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        ...
                                        <td width="10">&nbsp;</td>
                                            ...
                                            <asp:TextBox ID="txtcasepack" runat="server" MaxLength="15" Width="100px" placeholder="Total Case" Enabled="false"
                                             ...
                                             <asp:Label ID="Label17" runat="server" Text="ACCEPTED PCS QTY" Font-Bold="True"></asp:Label></span>
                                            </td>
                                            ...
                                            <asp:TextBox ID="txtrejectedcasepack" runat="server" MaxLength="15" Width="100px" placeholder="Total Case" Enabled="false"
                                             Font-Bold="true"></asp:TextBox>
                                             <span class="label_intro">
                                             <asp:Label ID="Label2" runat="server" Text="REJECTED PCS QTY" Font-Bold="True"></asp:Label></span>
                                            </td>
                                            <td width="130" class="innerfield_title" style="padding-left: 10px;" runat="server" id="Td1">
                                                <asp:Label ID="chk" runat="server" Text="QC DOCUMENT UPLOAD" ForeColor="Blue"></asp:Label>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn_24_blue" id="divbtnApproved" runat="server" style="display:none">
                                                    <span class="icon disk_co"></span>
                                                    <asp:Button ID="btnApproved" runat="server" Text="Approve" CssClass="btn_link" OnClick="btnApproved_Click" />
                                                </div>
                                                <div class="btn_24_red" id="divBtnReject" runat="server" style="display:none">
                                                    <span class="icon disk_danger"></span>
                                                    <asp:Button ID="btnReject" runat="server" Text="Reject" CssClass="btn_link" OnClick="btnReject_Click" />
                                                </div>
                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                <div class="btn_24_blue">
                                        ...
                                        <tr>
                                               <td width="290">
                                                    <asp:TextBox ID="txtRejectionNote" runat="server" BackColor="#ff9999" BorderColor="#000000"  placeholder="Rejection Reason"  TextMode="MultiLine">
                                                    </asp:TextBox>
                                              </td>
                                            </tr>
                                    </table>
                                    ...
                                    <div class="gridcontent">
                                        <cc1:Grid ID="gvCurrentQcdetails" runat="server" CallbackMode="true" Serialize="true" PageSize="200" EnableRecordHover="true"
                                            ...
                                            <Columns>
                                                ...
                                                <cc1:Column ID="Column24" DataField="TPUNAME" HeaderText="TPU NAME" runat="server"  Width="220" Wrap="true">
                                                    <FilterOptions>
                                                        <cc1:FilterOption Type="NoFilter" />
                                                        <cc1:FilterOption Type="EqualTo" />
                                                        <cc1:FilterOption Type="Contains" />
                                                ...
                                                <cc1:Column ID="Column38" DataField="TOTALACCEPTEDCASE" HeaderText="TOTAL ACCEPTED CASE" runat="server" Width="155" Wrap="true">
                                                </cc1:Column>
                                                <cc1:Column ID="Column39" DataField="TOTALREJECTEDCASE" HeaderText="TOTAL REJECTED CASE" runat="server" Width="155" Wrap="true">
                                                </cc1:Column>
                                                <cc1:Column ID="Column43" DataField="STATUS" HeaderText="QA STATUS" runat="server" Width="100" Wrap="true">
                                                </cc1:Column>
                                                <cc1:Column ID="Column44" DataField="QCREFNO" HeaderText="QC REF NO" runat="server" Width="100" Wrap="true">
                                                </cc1:Column>
