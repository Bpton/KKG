...
public partial class VIEW_frmChequeBookletCancel : System.Web.UI.Page
{
    ...
    public void btnApprove_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (totalcount <= 500)
            {
                ...
                ClsVoucherEntry clsreport = new ClsVoucherEntry();
                string Status = clsreport.InsertChequeCancel(Session["UserID"].ToString().Trim(), xml, "C");

                if (Status == "1")
                {
                    MessageBox1.ShowSuccess("Cheque Cancel  successfully.");
                ...
                {
                    MessageBox1.ShowError("Cheque Cancel unsuccessful.");
                    Session["BOOKLETDETAILS"] = null;
                }
    ...
    public void btnReject_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {          
                ...
                ClsVoucherEntry clsreport = new ClsVoucherEntry();
                string Status = clsreport.InsertChequeCancel(Session["UserID"].ToString().Trim(), xml, "D");

                if (Status == "1")
                {
                    MessageBox1.ShowSuccess("Cheque Disposal  successfully.");
                ...
                {
                    MessageBox1.ShowError("Cheque Disposal unsuccessful.");
                    Session["BOOKLETDETAILS"] = null;
                }
