<%@ Page Title="" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true" CodeFile="frmProductUpload.aspx.cs" Inherits="VIEW_frmProductUpload" %>
                                            ...
                                            <td class="field_title" colspan="4">
                                                <div class="btn_24_blue">
                                                    ...
                                                    <asp:Button ID="btnUpload" runat="server" Text="Upload" OnClick="btnUpload_Click" CssClass="btn_link"
                                                        ValidationGroup="ADD" OnClientClick="return confirm('Are you sure you want to upload attached product?')" />
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
