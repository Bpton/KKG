<%@ Page Title="" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true" CodeFile="frmUploadOpeningStockV2_FAC.aspx.cs" Inherits="VIEW_frmUploadOpeningStockV2_FAC" %>
                    ...
                    <div class="grid_12">
                        <div class="widget_wrap">
                            <div class="widget_top active" id="trBtn" runat="server">
                                ...
                                <h6>
                                    Upload Opening Stock Details</h6>
                            </div>
                                       ...
                                       <td class="field_input"  colspan="4">
                                        ...
                                        <tr>
                                            <td class="field_title" width="100px">
                                                <asp:Label ID="lbl1" Text="OPENING DATE" runat="server"></asp:Label>
                                            </td>
                                            <td class="field_input" width="120px">
                                                <asp:TextBox ID="txtopeningdate" runat="server" Width="70" MaxLength="10" Enabled="true"></asp:TextBox>
                                            ...
                                            <td class="field_title" width="120px">
