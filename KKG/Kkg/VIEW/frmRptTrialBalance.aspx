<%@ Page Title="" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true"
    CodeFile="frmRptTrialBalance.aspx.cs" Inherits="VIEW_frmRptTrialBalance" %>
    ...
    <asp:UpdateProgress ID="UpdateProgress" runat="server">
        <ProgressTemplate>
         <div align="center">
            ...
            <br /><b style="font-size:small;">Please wait.......  processing will take time to execute!</b>
            </div>
        </ProgressTemplate>
    </asp:UpdateProgress>
                    ...
                    <div class="grid_12">
                        <div class="widget_wrap">
                            <div class="widget_top active" id="trBtn" runat="server">
                                ...
                                <h6>
                                    <asp:Label ID="lbltype" runat="server" Text="Trial Balance"></asp:Label>
                                </h6>
                            </div>
                            <div class="widget_content">
                                <asp:Panel ID="pnlDisplay" runat="server">
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        ...
                                                        <td class="field_input" width="250">
                                                            <asp:DropDownList ID="ddlregion" runat="server" AppendDataBoundItems="True" Width="240"
                                                        ...
                                                        <td width="100" class="field_input">
                                                            <asp:TextBox ID="txttodate" runat="server" Enabled="false" Width="65" placeholder="dd/MM/yyyy"  
                                                                MaxLength="10"></asp:TextBox>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td class="field_input" width="150">
                                                            <asp:DropDownList ID="ddlType" runat="server" AppendDataBoundItems="True" Width="150"
                                                                ...
                                                                <asp:ListItem Text="Group Wise Summary" Value="S"></asp:ListItem>
                                                                <asp:ListItem Text="Ledger Wise Summary" Value="G"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td class="field_title" width="60">
                                                            <asp:Label ID="Label3" runat="server" Text="Report Format :"></asp:Label>
                                                        </td>
                                                        <td class="field_input" width="90" >
                                                              <asp:RadioButtonList id="rbdReport" runat="server">
                                                               <asp:ListItem Selected="True" Value="All">All</asp:ListItem>
                                                               <asp:ListItem Value="Opening">Opening</asp:ListItem>
                                                               <asp:ListItem Value="During">During</asp:ListItem>
                                    ...
                                    <div class="gridcontent">
                                        ...
                                        <div style="overflow: scroll; padding-right:8px;" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                            <asp:GridView ID="grdledger" runat="server" Width="100%" AutoGenerateColumns="false" OnRowDataBound="grdledger_RowDataBound"
                                                OnRowCommand="grdledger_RowCommand"
                                                CssClass="trialbalancegrid" EmptyDataText="No Records Available.....">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="PARTICULARS">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblgrpname" runat="server" Text='<%# Bind("grpname") %>' Width="425px"></asp:Label>
                                                    ...
                                                    <asp:TemplateField HeaderText="DURING DEBIT" ItemStyle-HorizontalAlign="Right">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl18" runat="server" Text='<%# Bind("debit") %>' Width="105px"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="DURING CREDIT" ItemStyle-HorizontalAlign="Right">
                                                        <ItemTemplate>
                                             ...
                                             <asp:GridView ID="grdledger_for_excel" runat="server" Width="100%" AutoGenerateColumns="false" OnRowDataBound="grdledgerexport_RowDataBound"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="PARTICULARS">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblname" runat="server" Text='<%# Bind("NAME") %>' Width="425px"></asp:Label>
                                                        </ItemTemplate>
