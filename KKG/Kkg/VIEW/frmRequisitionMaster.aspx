<%@ Page Title="" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true" CodeFile="frmRequisitionMaster.aspx.cs" Inherits="VIEW_frmRequisitionMaster" %>
                            ...
                            <div class="widget_content">
                                <asp:Panel ID="InputTable" runat="server">
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                                                        <tr>
                                                            ...
                                                            <td class="field_input" colspan="8">
                                                                <asp:DropDownList ID="ddldepartment" runat="server" Width="120" AutoPostBack="true"
                                                             ...
                                                             <td class="field_title">
                                                                <asp:Label ID="lblStorelocation" runat="server" Text="Storelocation"></asp:Label>&nbsp;<span class="req">*</span>
                                                            </td>
                                                            <td class="field_input" colspan="6">
                                                                <asp:DropDownList ID="ddlStorelocation" runat="server" Width="170" AutoPostBack="true"
                                                ...
                                                <fieldset>
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                                                        <tr>
                                                            ...
                                                            <td width="50" class="field_input">
                                                                <asp:DropDownList ID="ddlsupplieditem" runat="server" Width="170" AutoPostBack="true"
                                                            ...
                                                            <td class="field_input">
                                                                <asp:DropDownList ID="ddlfactory" runat="server" AppendDataBoundItems="true" class="chosen-select"
                                                                    Style="width: 100px;" data-placeholder="Choose a Factory" OnSelectedIndexChanged="ddlfactory_SelectedIndexChanged" AutoPostBack="true">
                                                                </asp:DropDownList>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="60" class="field_input">
                                                                <asp:TextBox ID="txtStockQty" runat="server" Width="50"  Enabled="false"
                                                            ...
                                                            <td width="60" class="field_input">
                                                                <asp:TextBox ID="txtOwnQty" runat="server" Width="50"  Enabled="false"
                                                                    data-placeholder="Stock Qty">
                                                                </asp:TextBox>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="field_input">
                                                                ...
                                                                <asp:HiddenField ID="hdn_requisitionguiddelete" runat="server" />
                                                                 ...
                                                                 <asp:HiddenField ID="hdOwnLocationID" runat="server" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </fieldset>
                                    ...
                                    <div class="gridcontent-inner">
                                        <fieldset>
                                            <legend>REQUISITION MATERIAL DETAILS</legend>
                                            <cc1:Grid ID="gvRequisition" runat="server" CallbackMode="true" Serialize="true"
                                                ...
                                                <Columns>
                                                    ...
                                                    <cc1:Column ID="Column2" DataField="MATERIALNAME" HeaderText="MATERIAL" runat="server"
                                                        Width="350" Wrap="true">
                                                        <FilterOptions>
                                                            <cc1:FilterOption Type="NoFilter" />
                                                            <cc1:FilterOption Type="EqualTo" />
                                                    ...
                                                    <cc1:Column ID="ColumnDESTINATION" DataField="DESTINATION_STOCKQTY" HeaderText="DESTINATION STOCK QTY" runat="server"
                                                        Width="80" Wrap="true">
                                                        <FilterOptions>
                                                            <cc1:FilterOption Type="NoFilter" />
                                                            <cc1:FilterOption Type="EqualTo" />
                                                     ...
                                                     <cc1:Column ID="ColumnOWN" DataField="OWN_STOCKQTY" HeaderText="OWN STOCK QTY" runat="server"
                                                        Width="80" Wrap="true" >
                                                        <FilterOptions>
                                                            <cc1:FilterOption Type="NoFilter" />
                                                            <cc1:FilterOption Type="EqualTo" />
                                                    ...
                                                    <cc1:Column ID="Column17" DataField="QTY" HeaderText="REQUISTION QTY" runat="server"
                                                        Width="100" Wrap="true">
                                                        <FilterOptions>
                                                            <cc1:FilterOption Type="NoFilter" />
                                                            <cc1:FilterOption Type="EqualTo" />
                                                    ...
                                                    <cc1:Column ID="Column3" DataField="QTY" HeaderText="REQUISTION QTY" runat="server"
                                                        Width="200" Wrap="true">
                                                        <FilterOptions>
                                                            <cc1:FilterOption Type="NoFilter" />
                                                            <cc1:FilterOption Type="EqualTo" />
                                                    ...
                                                    <cc1:Column ID="Column11" DataField="UOMNAME" HeaderText="UNIT" runat="server" Width="170"
                                                        Wrap="true">
                                                        <FilterOptions>
                                                            <cc1:FilterOption Type="NoFilter" />
                                                            <cc1:FilterOption Type="EqualTo" />
                                                    ...
                                                    <cc1:Column ID="Column15" DataField="REQUIREDFROMDATE" HeaderText="REQUIRED DATE"
                                                    ...
                                                    <cc1:Column ID="Column10" DataField="REQUIREDTODATE" HeaderText="REQUIRED DATE" runat="server"
                                ...
                                <asp:Panel ID="pnlDisplay" runat="server">
                                    ...
                                    <div class="gridcontent">
                                        <cc1:Grid ID="gvRequisitiondetails" runat="server" CallbackMode="false" Serialize="true"
                                            ...
                                            <FilteringSettings InitialState="Visible" />
                                            <Columns>
                                                <cc1:Column ID="Column14" DataField="REQUISITIONID" HeaderText="REQUISITIONID" runat="server"
                                                ...
                                                <cc1:Column ID="Column6" DataField="REQUISITIONDATE" HeaderText="REQUISITION DATE"
                                                ...
                                                <cc1:Column ID="Column7" DataField="REQUISITIONNO" HeaderText="REQUISITION NO" runat="server"
                                                    Width="100%" Wrap="true">
                                                    <FilterOptions>
                                                        <cc1:FilterOption Type="NoFilter" />
                                                        <cc1:FilterOption Type="EqualTo" />
                                                ...
                                                <cc1:Column ID="Column9" DataField="PRODUCTION_NO" HeaderText="PRODUCTIONNO" runat="server"
                                                    Width="100%" Wrap="true" Visible="false">
                                                    <FilterOptions>
                                                        <cc1:FilterOption Type="NoFilter" />
                                                        <cc1:FilterOption Type="EqualTo" />
                                                ...
                                                <cc1:Column ID="Column23" DataField="TOTALMATERIAL" HeaderText="TOTAL MATERIAL" runat="server"
