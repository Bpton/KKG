<%@ Page Title="Welcome to McNROE" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true"
    CodeFile="frmAccAdvanceVoucher.aspx.cs" Inherits="VIEW_frmAccAdvanceVoucher" %>
            ...
            <div id="contentarea">
                        ...
                        <div class="widget_wrap">
                            ...
                            <div class="widget_top active" id="trBtn" runat="server">
                                ...
                                <div class="btn_30_light" style="float: right;" id="btnaddhide" runat="server">
                                    ...
                                    <asp:Button ID="Btnadd" runat="server" Text="Add New Voucher" CssClass="btn_link" AccessKey="N"
                                        CausesValidation="false" OnClick="Btnadd_Click" UseSubmitBehavior="false" />
                                </div>
                            </div>
                            <div class="widget_content">
                                                ...
                                                <fieldset>
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #e3ede1;">
                                                        <tr id="trvoucherno" runat="server">
                                                            <td class="field_title">Voucher No
                                                            </td>
                                                            <td colspan="5">
                                                        ...
                                                        <tr>
                                                            <td width="70" class="field_title">Voucher<span class="req">*</span>
                                                            </td>
                                                            ...
                                                            <td width="140" id="trpaymentmode" runat="server">
                                                                <table width="140" cellpadding="0" cellspacing="0" border="0">
                                                                    <tr>
                                                                        <td width="50" class="field_title">MODE&nbsp;&nbsp;<span class="req">*</span>
                                                                        </td>
                                                            ...
                                                            <td width="61" class="field_title">Region<span class="req">*</span>
                                                            </td>
                                                            ...
                                                            <td width="61" class="field_title">Voucher Type<span class="req">*</span>
                                                            </td>
                                                            ...
                                                            <td width="90" class="field_title">Voucher Date<span class="req">*</span>
                                                            </td>
                                                            <td class="field_input">
                                                                <asp:TextBox ID="txtvoucherdate" runat="server" Width="60" Enabled="false" Font-Bold="true" AutoPostBack="true" OnTextChanged="txtvoucherdate_TextChanged" />
                                                            ...
                                                            <td width="50" class="field_title">Place Of Supply&nbsp;&nbsp;
                                                            </td>
                                                    ...
                                                    <table>
                                                        <div id="btngstonly" runat="server">
                                                            <td width="50" class="field_title">Party Name&nbsp;&nbsp;
                                                            </td>
                                                            <td width="70" class="field_input">
                                                            ...
                                                            <td width="35" class="field_title">GSTIN
                                                            </td>
                                                            ...
                                                            <td width="35" class="field_title">Date
                                                            </td>
                                                            <td class="field_input">
                                                            ...
                                                            <td class="field_input" width="5px">
                                                                <asp:TextBox ID="txtInvoiceNo" runat="server" Text="" Width="95px" MaxLength="20"
                                                                    CssClass="abacus" AutoPostBack="true" placeholder="GST ONLY" OnTextChanged="txtInvoiceNo_TextChanged"></asp:TextBox>
                                                            </td>
                                                            <td class="field_title">
                                                                <asp:Label ID="Label25" Text="TAX(%)&nbsp;" runat="server"></asp:Label>
                                                            </td>
                                                            <td class="field_input" width="5px">
                                                                <asp:TextBox ID="txtTaxPercent" runat="server" Text="" Width="95px" MaxLength="20"
                                                                    CssClass="abacus" AutoPostBack="true" placeholder="Tax Percent" onkeypress="return isNumberKeyWithDot(event);" OnTextChanged="txtTaxPercent_TextChanged"></asp:TextBox>
                                                            </td>
                                                            <td class="field_title">
                                                                <asp:Label ID="Label26" Text="Taxable Value&nbsp;" runat="server"></asp:Label>
                                                            </td>
                                                            <td class="field_input" width="5px">
                                                                <asp:TextBox ID="txtTaxValue" runat="server" Text="" Width="95px" MaxLength="20"
                                                                    CssClass="abacus" AutoPostBack="true" placeholder="Taxable" onkeypress="return isNumberKeyWithDot(event);" OnTextChanged="txtTaxValue_TextChanged"></asp:TextBox>
                                                            </td>
                                                            <td class="field_title">
                                                        ...
                                                        <tr id="innertr" runat="server">
                                                            <td>
                                                                                            ...
                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_container_td">
                                                                                                <tr id="traccountinfodebit" runat="server">
                                                                                                    ...
                                                                                                    <td align="left" class="field_input">
                                                                                                        <asp:DropDownList ID="ddlAccTypeDr" Width="260" runat="server" class="chosen-select" AutoPostBack="true" OnSelectedIndexChanged="ddlAccTypeDr_SelectedIndexChanged">
                                                                                                        </asp:DropDownList>
                                                                                                    ...
                                                                                                    <td align="left" class="field_input" id="td1" runat="server">
                                                                                                        ...
                                                                                                        <asp:Label ID="Label28" runat="server" Text="Closing Balance"></asp:Label>&nbsp;&nbsp;&nbsp;
                                                                                                        <span>
                                                                                                            <asp:Label ID="lblDrClosingBalance" runat="server" Text="0.00"></asp:Label></span>
                                                                                                    </td>
                                                                                                    <td class="field_title">
                                                                                                    ...
                                                                                                    <td align="left" class="field_input" colspan="4">
                                                                                                        <table>
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <asp:TextBox ID="txtdebitchequeno" runat="server" placeholder="Enter No." Width="180"
                                                                                        ...
                                                                                        <fieldset>
                                                                                            ...
                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_container_td">
                                                                                                <tr id="traccountinfocredit" runat="server">
                                                                                                    ...
                                                                                                    <td align="left" class="field_input">
                                                                                                        <asp:DropDownList ID="ddlAcctypeCr" Width="220" runat="server" AutoPostBack="true" class="chosen-select" OnSelectedIndexChanged="ddlAcctypeCr_SelectedIndexChanged">
                                                                                                        </asp:DropDownList>
                                                                                                    ...
                                                                                                    <td align="left" class="field_input" id="td2" runat="server">
                                                                                                        <%--<p style="margin:0px 0px; padding: 0px 0px;" class="smallpopup" id="tooltip1"><a href="#">OutStanding<span id="lbldebitsideoutstanding" runat="server">0</span></a></p>--%>
                                                                                                        <asp:Label ID="Label29" runat="server" Text="Closing Balance"></asp:Label>&nbsp;&nbsp;&nbsp;
                                                                                                        <span>
                                                                                                            <asp:Label ID="lblCrClosingBalance" runat="server" Text="0.00"></asp:Label></span>
                                                                                                    </td>
                                                                                                    <td class="field_title">
                                                                                                    ...
                                                                                                    <td align="left" class="field_input" colspan="4">
                                                                                                        <table>
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td id="tdDropdown" runat="server">
                                                                                                                    <%--   <asp:TextBox ID="txtcreditchequeno" runat="server" placeholder="Enter No" MaxLength="17"
                                                                                                                        Width="100"></asp:TextBox>--%>

                                                                                                                    <asp:DropDownList ID="txtcreditchequeno" Width="180" runat="server" class="chosen-select">
                                                                                                                    </asp:DropDownList>
                                                                                                                ...
                                                                                                                <td id="tdtxtBox" runat="server">
                                                                                                                    <asp:TextBox ID="txtNeftNo" Width="180" runat="server" />
                                                                                                                    <span class="label_intro">
                                                                                                                        <asp:Label ID="lblNftNo" align="right" runat="server" Text=""></asp:Label></span>
                                                                                                                    <%--<asp:Label ID="lblrtgsNo" align="right" runat="server" Text="No"></asp:Label></span>--%>
                                                                                                                    <td />

                                                                                                                    <%--  <td id="tdrtgstxtBox" runat="server">
                                                                                                                     <asp:TextBox ID="txtrtgsNo" Width="180" runat="server" />
                                                                                                                             <span class="label_intro">
                                                                                                                        <asp:Label ID="lblrtgsNo" align="right" runat="server" Text="No"></asp:Label></span>
                                                                                                                         <td/>--%>
                                                                                                                </td>
                                                                ...
                                                                <asp:Panel ID="trinvoicedetails" runat="server">
                                                                    <br />
                                                                    <div style="border: thin solid #257daf">
                                                                        <div style="background-color: #257daf; border-style: solid; border-color: Yellow; background-position: center; background-repeat: no-repeat; background-size: cover; height: 3%"
                                                                            align="center">
                                            ...
                                            <span class="icon rupee_co"></span>
                                                                        ...
                                                                        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                                                                            <tr>
                                                                                <td class="field_input" style="padding-left: 8px;">
                                                                                    <fieldset>
                                                                                        <%--style="border-color: #257daf"--%>
                                                                                        <legend>Invoice Details</legend>
                                                                                        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td"
                                                                                            style="display: none;">
                                                                                            <tr>
                                                                                                <td class="field_title" width="60">Account
                                                                                                </td>
                                                                                                <td class="field_input">
                                                                                        ...
                                                                                        <div class="gridcontent-inner" style="overflow: scroll; height: 250px; border: 1px solid #ccc;">
                                                                                            <%--<div style="overflow: hidden; width: 100%;" id="DivHeaderRow_InvoiceDetails">
                                                                                        </div>
                                                                                        <div style="overflow: scroll; border: 1px solid #ccc;" onscroll="MakeStaticHeader_InvoiceDetails('<%= grd_InvoiceDetails.ClientID %>', 220, '99%' , 30 ,false)"
                                                                                            id="DivMainContent_InvoiceDetails">--%>
                                                                                            <asp:GridView ID="grd_InvoiceDetails" EmptyDataText="There are no records available."
                                                                                                ...
                                                                                                <Columns>
                                                                                                    ...
                                                                                                    <asp:TemplateField HeaderText="Type" ItemStyle-HorizontalAlign="Center">
                                                                                                        <ItemTemplate>
                                                                                                            <asp:TextBox ID="txttxntype" runat="server" Text='<%# Bind("Type") %>' value='<%# Eval("Type") %>' Enabled="false" Width="60" />
                                                                                                        </ItemTemplate>
                                                                                                    </asp:TemplateField>
                                                                                                </Columns>
                                                                                            ...
                                                                                            <%--</div>--%>
                                                                                            <%--<div id="DivFooterRow_InvoiceDetails" style="overflow:hidden"></div>--%>
                                                                                        </div>
                                                                                            ...
                                                                                            <tr id="tr1" runat="server">
                                                                                                ...
                                                                                                <td align="right">
                                                                                                    <div style="padding-right: 30%;">
                                                                                                        <asp:Label ID="Label11" Text="Grand Total&nbsp;&nbsp;" runat="server" Font-Bold="true"></asp:Label>
                                                                ...
                                                                <asp:Panel ID="pnldebit_creditinvoice" runat="server" CssClass="modalPopup" Style="display: none; border-radius: 16px;"
                                                                    Width="50%" Height="65%" BackColor="White" BorderColor="#257daf"
                                                                    BorderWidth="8px" BorderStyle="Solid">
                                                                    <div style="background-color: #257daf; border-style: solid; border-color: Yellow; background-position: center; background-repeat: no-repeat; background-size: cover; height: 8%"
                                                                        align="center">
                                                                        <div style="float: left;" class="btn_24_blue">
                                                                            <span class="icon rupee_co"></span>
                                                                        </div>
                                                                        <asp:Label Font-Bold="True" ID="Label19" runat="server" Text="Invoice Details" Font-Size="X-Large"
                                                                            ForeColor="Yellow"></asp:Label>
                                                                        <asp:ImageButton ID="ImageButton8" ImageAlign="Right" ImageUrl="~/images/Cancel.png"
                                                                    ...
                                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                                                                        <tr>
                                                                            <td class="field_input" style="padding-left: 8px; padding-right: 20px;">
                                                                                <fieldset>
                                                                                    <legend>
                                                                                        <asp:Label ID="lbldebitledgername" runat="server" ForeColor="Blue"></asp:Label></legend>
                                                                                    <div class="gridcontent-inner" style="height: 200px; overflow: scroll;">
                                                                                        <asp:GridView ID="grd_debitcredit_invoice" EmptyDataText="There are no records available."
                                                                                            CssClass="reportgrid" OnRowDataBound="grd_debitcredit_invoice_RowDataBound" runat="server"
                                                                                            AutoGenerateColumns="False" Width="100%">
                                                                                            <Columns>
                                                                                                <asp:TemplateField HeaderText="SL" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Left"
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="LedgerId" Visible="false">
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="lbldebitcreditledgerid" runat="server" Text='<%# Bind("LedgerId") %>'
                                                                                                            value='<%# Eval("LedgerId") %>' />
                                                                                                    </ItemTemplate>
                                                                                                </asp:TemplateField>
                                                                                                <asp:TemplateField HeaderText="LedgerName" Visible="false">
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="lbldebitcreditledgername" runat="server" Text='<%# Bind("LedgerName") %>'
                                                                                                            value='<%# Eval("LedgerName") %>' />
                                                                                                    </ItemTemplate>
                                                                                                </asp:TemplateField>
                                                                                                <asp:TemplateField HeaderText="InvoiceID" Visible="false">
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="lbldebitcreditinvoiceid" runat="server" Text='<%# Bind("InvoiceID") %>'
                                                                                                            value='<%# Eval("InvoiceID") %>' />
                                                                                                    </ItemTemplate>
                                                                                                </asp:TemplateField>
                                                                                                <asp:TemplateField HeaderText="Invoice/Voucher No" ItemStyle-HorizontalAlign="Left">
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="lbldebitcreditinvoiceno" runat="server" Text='<%# Bind("InvoiceNo") %>'
                                                                                                            value='<%# Eval("InvoiceNo") %>' />
                                                                                                    </ItemTemplate>
                                                                                                </asp:TemplateField>
                                                                                                <asp:TemplateField HeaderText="Invoice Amt">
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="lbldebitcreditinvoiceamt" runat="server" Text='<%# Bind("InvoiceAmt") %>'
                                                                                                            value='<%# Eval("InvoiceAmt") %>' />
                                                                                                    </ItemTemplate>
                                                                                                </asp:TemplateField>
                                                                                            </Columns>
                                                                                            <RowStyle HorizontalAlign="Right" />
                                                                    ...
                                                                    <table id="table3" runat="server" width="100%" border="0" cellspacing="0" cellpadding="0"
                                                                        ...
                                                                        <tr id="tr5" runat="server">
                                                                            <td align="right" class="field_title" style="padding-right: 10px;">
                                                                                <div class="btn_24_blue" id="div3" runat="server">
                                                                                    <span class="icon rupee_co"></span>
                                                                                    <asp:Button ID="btndebitcredit_invoice" runat="server" Text="Done" CssClass="btn_link"
                                                                                        OnClick="btndebitcredit_invoice_Click" CausesValidation="false" />
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </asp:Panel>
                                                                <asp:LinkButton ID="lnkFakedebicreditinvoice" runat="server"></asp:LinkButton>
                                                                <ajaxToolkit:ModalPopupExtender ID="popupinvoicedebitcredit" runat="server" DropShadow="false"
                                                                    PopupControlID="pnldebit_creditinvoice" TargetControlID="lnkFakedebicreditinvoice"
                                                                    BackgroundCssClass="modalBackground">
                                                                </ajaxToolkit:ModalPopupExtender>
                                                                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                                                                    <tr style="background-color: #e3ede1;">
                                                                        <td width="8%" align="left" class="field_title">
                                                                            <asp:Label ID="Label17" Text="Narration" runat="server"></asp:Label><span class="req">*</span>
                                                                        </td>
                                                                        <td align="left" class="field_input">
                                                                            <asp:TextBox ID="txtNarration" runat="server" CssClass="x_large" TextMode="MultiLine"
                                                                                Height="40" Font-Bold="true" />
                                                                        ...
                                                                        <td style="padding-left: 10px;">
                                                                            ...
                                                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                                                            <div class="btn_24_blue" id="divclose" runat="server">
                                            ...
                                            <td class="field_title">
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        ...
                                                        <td width="300">
                                                            <asp:DropDownList ID="ddldepot" runat="server" class="chosen-select" Width="250px"
                                                        ...
                                                        <td width="110">
                                                            <asp:Label ID="Label23" runat="server" Text="Voucher Type"></asp:Label>
                                                            <%--Add by Romaprosad 16092019--%>
                                                            <span class="req">*</span>

                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="Dropdownadvancevouchertype" runat="server" class="chosen-select" Width="240">
                                ...
                                <asp:Panel ID="trcostcenterdetails" runat="server" CssClass="modalPopup" Style="display: none; border-radius: 16px;"
                                    Width="90%" Height="85%" BackColor="White" BorderColor="#257daf"
                                    BorderWidth="8px" BorderStyle="Solid">
                                        ...
                                        <tr>
                                            <td class="field_input" style="padding-left: 8px;">
                                                <fieldset>
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                                                        <tr>
                                                            <td class="field_title" width="70">Segment<span class="req">*</span>
                                                            </td>
                                                            ...
                                                            <td class="field_title" width="70">Brand
                                                            </td>
                                                            ...
                                                            <td class="field_title" width="70">Product
                                                            </td>
                                                            <td class="field_input">
                                                            ...
                                                            <td class="field_title" width="70">Department<span class="req">*</span>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="field_title">Branch<span class="req">*</span>
                                                            </td>
                                                            <td class="field_input">
                                                            ...
                                                            <td class="field_title">Cost Center
                                                            </td>
                                                            <td class="field_input">
                                                            ...
                                                            <td class="field_title">Amount<span class="req">*</span>
                                                            </td>
                                                            <td class="field_input">
                                                            ...
                                                            <td align="left" class="field_title">
                                                                <div class="btn_24_blue">
                                                                    <span class="icon add_co"></span>
                                                                    <asp:Button ID="btncostcenteradd" runat="server" Text="Add" CssClass="btn_link" OnClientClick="return amountzero_add();"
                                                                        OnClick="btncostcenteradd_Click" ValidationGroup="cost" CausesValidation="true" />
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <div class="gridcontent-inner" style="overflow: auto; height: 220px;">
                                                        ...
                                                        <asp:GridView ID="grdcostcenter" EmptyDataText="There are no records available."
                                                            DataKeyNames="GUID" CssClass="reportgrid" runat="server" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="AMOUNT" ItemStyle-Wrap="true" ItemStyle-HorizontalAlign="Right"
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <%--<asp:Label ID="lblamount" runat="server"   OnTextChanged="txtamount_SelectedIndexChanged" AutoPostBack="true"Text='<%# Bind("Amount") %>' value='<%# Eval("Amount") %>' />--%>
                                                                        <asp:TextBox ID="txtamount" runat="server" Style="text-align: right;" Text='<%# Bind("Amount") %>'
                                                                            ...
                                                                            MaxLength="10" onkeyup="OverAllShare(this);" onchange="OverAllShare(this);">
                                                                        </asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <asp:Label ID="lblfooteramount" runat="server" Text='<%# Bind("totalamount") %>'
                                                            ...
                                                            <td align="right" class="field_title">
                                                                <div class="btn_24_blue">
                                                                    ...
                                                                    <asp:Button ID="btncostcentersave" runat="server" Text="Save" CssClass="btn_link"
                                                                        OnClientClick="return amountzero_save();" OnClick="btncostcentersave_Click" CausesValidation="false" />
                                                                </div>
                                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                                <div class="btn_24_blue">
                                                                    <span class="icon cross_octagon_co"></span>
                                ...
                                <asp:Panel ID="trtaxdetails" runat="server" CssClass="modalPopup" Style="display: none; border-radius: 16px;"
                                    Width="40%" Height="63%" BackColor="White" BorderColor="#257daf"
                                    BorderWidth="8px" BorderStyle="Solid">
                                    <div style="background-color: #257daf; border-style: solid; border-color: Yellow; background-position: center; background-repeat: no-repeat; background-size: cover; height: 8%"
                                        align="center">
                                        <div style="float: left;" class="btn_24_blue">
                                        ...
                                        <asp:Label Font-Bold="True" ID="Label21" runat="server" Text="Tax Details" Font-Size="X-Large"
                                            ForeColor="White"></asp:Label>
                                        ...
                                        <tr>
                                            <td class="field_input" style="padding-left: 8px; padding-right: 20px;">
                                                <fieldset>
                                                    ...
                                                    <div class="gridcontent" style="height: 180px; overflow: scroll;">
                                                        <asp:GridView ID="grdapplicabletax" EmptyDataText="There are no records available."
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="SL" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Left">
                                                                    <ItemTemplate>
                                                                        <nav style="height: 0px; z-index: 2; padding-left: 8px; position: relative; text-align: center;"><span class="badge black"><%# Container.DataItemIndex + 1 %></span></nav>
                                ...
                                <asp:Panel ID="pnlotherdetails" runat="server" CssClass="modalPopup" Style="display: none; border-radius: 16px;"
                                    Width="55%" Height="63%" BackColor="White" BorderColor="#257daf"
                                    BorderWidth="8px" BorderStyle="Solid">
                                    <div style="background-color: #257daf; border-style: solid; border-color: Yellow; background-position: center; background-repeat: no-repeat; background-size: cover; height: 8%"
                                        align="center">
                                        <div style="float: left;" class="btn_24_blue">
                                        ...
                                        <asp:Label Font-Bold="True" ID="Label8" runat="server" Text="Other Details" Font-Size="X-Large"
                                            ForeColor="Yellow"></asp:Label>
                                            ...
                                            <td class="field_input" style="padding-left: 8px;">
                                                <fieldset>
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                                                        ...
                                                        <tr>
                                                            <td class="field_title">Vehicle No.
                                                            </td>
                                ...
                                <asp:Panel ID="pnlChequeRealised" runat="server" CssClass="modalPopup" Style="display: none; border-radius: 16px;"
                                    Width="47%" Height="25%" BackColor="White" BorderColor="#257daf"
                                    BorderWidth="8px" BorderStyle="Solid">
                                    <div style="background-color: #257daf; border-style: solid; border-color: Yellow; background-position: center; background-repeat: no-repeat; background-size: cover; height: 20%"
                                        align="center">
                                        <div style="float: left;" class="btn_24_blue">
                                            <span class="icon rupee_co"></span>
                                        </div>
                                        <asp:Label Font-Bold="True" ID="Label20" runat="server" Text="Release Details" Font-Size="X-Large"
                                            ForeColor="Yellow"></asp:Label>
                                        <asp:ImageButton ID="imgcloserealished" ImageAlign="Right" ImageUrl="~/images/Cancel.png"
                                            Height="25px" Width="25px" runat="server" OnClick="imgcloserealished_click" Style="position: absolute; top: -15px; right: -15px;" />
                                        <hr />
                                    </div>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                                        <tr>
                                            <td class="field_input" style="padding-left: 8px;">
                                                <fieldset>
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                                                        <tr>
                                                            <td class="field_title" width="80">Released No.
                                                            </td>
                                                            <td class="field_input">
                                ...
                                <%--<div id="Modal" class="white_content" runat="server" style="width:auto;text-align:center ;height:8px;opacity:100">
                                                            <div class="header" style="text-align: right;">
                                                                <asp:Button ID="Button1" runat="server" Text="Close" CssClass="btn-danger" CausesValidation="false"
                                                                    OnClick="Button1_Click" AccessKey="Z"/>
                                                            </div>
                                                                   <label style="color:orangered">SHOW INFO(ALT+I), </label>&nbsp;
                                                                   <label style="color:blueviolet">ADD NEW(ALT+N), </label>&nbsp;; 
                                                                   <label style="color:orangered">DEBIT ADD(ALT+B), </label>&nbsp;
                                                                   <label style="color:blueviolet">CREDIT ADD(ALT+C), </label>&nbsp;
                                                                   <label style="color:orangered">DEBIT DELETE(ALT+H),</label>&nbsp;
                                                                   ...
                                                                   <label style="color:blueviolet">SAVE WITH PRINT(ALT+P),</label>&nbsp;
                                                                   <label style="color:orangered">CLOSE(ALT+X),</label>&nbsp;
                                                                   <label style="color:blueviolet">CLOSE POPUP(ALT+Z)</label>
                            </div>--%>
                            </div>
                        </div>
                    </div>
                ...
                <script type="text/javascript" language="javascript">
                    function toggleTypeheaderSelectionchecked(checkbox) {
                        ...
                        //var e = document.getElementById("ddlvouchertype"); 
                        var e = document.getElementById("<%=ddlvouchertype.ClientID%>"); // select element  
                        ...
                        var debitAmount = document.getElementById('ContentPlaceHolder1_txtAmtDr');
                        var creditAmnt = document.getElementById('ContentPlaceHolder1_txtAmntCr');
                        ...
                        for (var ii = 0; ii < grid.rows.length - 1; ii++) {
                            ...
                            var idtype = "ContentPlaceHolder1_grd_InvoiceDetails_txttxntype_" + ii;
                            ...
                            if (paymentType == "15") { /*advance payment*/
                                if (type == "Dr") {
                                    total = (parseFloat(total) - parseFloat(remainpaid1)).toFixed(2);
                                }
                                if (type == "Cr") {
                                    total = (parseFloat(total) + parseFloat(remainpaid1)).toFixed(2);
                                }
                            }
                            else if (paymentType == "16") { /*advance receipt*/
                                 if (type == "Dr") {
                                    total = (parseFloat(total) + parseFloat(remainpaid1)).toFixed(2);
                                 }
                                 if (type == "Cr") {
                        ...
                        debitAmount.value = total;
                        creditAmnt.value = total;
                    }
                </script>
                <script type="text/javascript" language="javascript">
                    function toggleHeaderTextSelection() {
                        ...
                        for (var ii = 0; ii < grid.rows.length - 1; ii++) {
                            ...
                            if (paymentType == "15") { /*advance payment*/
                                if (type == "Dr") {
                                    total = (parseFloat(total) - parseFloat(remainpaid)).toFixed(2);
                                }
                                if (type == "Cr") {
                                    total = (parseFloat(total) + parseFloat(remainpaid)).toFixed(2);
                                }
                            }
                            else if (pamentType == "16") { /*advance receipt*/
                                 if (type == "Dr") {
                                    total = (parseFloat(total) + parseFloat(remainpaid)).toFixed(2);
                                 }
                                 if (type == "Cr") {
                ...
                <script type="text/javascript">
                    ...
                    $(document).ready(function () {
                        ...
                        BlockUI("<%=pnldebit_creditinvoice.ClientID %>");
                        $.blockUI.defaults.css = {};
                    });
                    function Hidepopup() {
                        $find("popupinvoicedebitcredit").hide();
                        return false;
                    }
                    $(document).ready(function () {
                ...
                <script language="javascript" type="text/javascript">
                    function MakeStaticHeader_invoice(gridId, height, width, headerHeight, isFooter) {
                        var tbl = document.getElementById(gridId);
                        if (tbl) {
                            var DivHR_inv = document.getElementById('DivHeaderRow_invoice');
                            var DivMC_inv = document.getElementById('DivMainContent_invoice');
                            var DivFR_inv = document.getElementById('DivFooterRow_invoice');
                    ...
                    function OnScrollDiv(Scrollablediv) {
                        document.getElementById('DivHeaderRow_invoice').scrollLeft = Scrollablediv.scrollLeft;
                        document.getElementById('DivFooterRow_invoice').scrollLeft = Scrollablediv.scrollLeft;
                    }
                </script>
                <script language="javascript" type="text/javascript">
                ...
                <script language="javascript" type="text/javascript">
                    function MakeStaticHeader_InvoiceDetails(gridId, height, width, headerHeight, isFooter) {
                        var tbl = document.getElementById(gridId);
                        if (tbl) {
                            var DivHR_InvoiceDetails = document.getElementById('DivHeaderRow_InvoiceDetails');
                            var DivMC_InvoiceDetails = document.getElementById('DivMainContent_InvoiceDetails');
                            var DivFR_InvoiceDetails = document.getElementById('DivFooterRow_InvoiceDetails');

                            //*** Set divheaderRow Properties ****
                            DivHR_InvoiceDetails.style.height = headerHeight + 'px';
                            //DivHR_InvoiceDetails.style.width = (parseInt(width) - 16) + 'px';
                            DivHR_InvoiceDetails.style.width = '97%';
                            DivHR_InvoiceDetails.style.position = 'relative';
                            DivHR_InvoiceDetails.style.top = '0px';
                            DivHR_InvoiceDetails.style.zIndex = '10';
                            DivHR_InvoiceDetails.style.verticalAlign = 'top';

                            //*** Set divMainContent Properties ****
                            DivMC_InvoiceDetails.style.width = width + 'px';
                            DivMC_InvoiceDetails.style.height = height + 'px';
                            DivMC_InvoiceDetails.style.position = 'relative';
                            DivMC_InvoiceDetails.style.top = -headerHeight + 'px';
                            DivMC_InvoiceDetails.style.zIndex = '1';

                            //*** Set divFooterRow Properties ****
                            DivFR_InvoiceDetails.style.width = (parseInt(width) - 16) + 'px';
                            DivFR_InvoiceDetails.style.position = 'relative';
                            DivFR_InvoiceDetails.style.top = -headerHeight + 'px';
                            DivFR_InvoiceDetails.style.verticalAlign = 'top';
                            DivFR_InvoiceDetails.style.paddingtop = '2px';
                            ...
                            if (isFooter) {
                                ...
                                tblBody.appendChild(tbl.rows[tbl.rows.length - 1]);
                                tblfr.appendChild(tblBody);
                                DivFR_InvoiceDetails.appendChild(tblfr);
                            }
                            //****Copy Header in divHeaderRow****
                            DivHR_InvoiceDetails.appendChild(tbl.cloneNode(true));
                        }
                    }

                    function OnScrollDiv(Scrollablediv) {
                        document.getElementById('DivHeaderRow_InvoiceDetails').scrollLeft = Scrollablediv.scrollLeft;
                        document.getElementById('DivFooterRow_InvoiceDetails').scrollLeft = Scrollablediv.scrollLeft;
                    }
                ...
                <script type="text/javascript">
                    function blockSpecialChar(e) {
                        ...
                        document.getElementById("<%=txtTaxPercent.ClientID%>").focus();
                        return false;
                    }
                </script>
                <script type="text/javascript" language="javascript">
                    function OverAllShare(a) {
                        var diff = 0;
