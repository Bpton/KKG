<%@ Page Title="" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true" CodeFile="frmItemTypeMaster.aspx.cs" Inherits="VIEW_frmItemTypeMaster" %>
            ...
            <div id="contentarea">
                            ...
                            <div class="widget_content">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                                        <tr>
                                            ...
                                            <td class="field_input">
                                                <asp:TextBox ID="txtITCode" runat="server" CssClass="mid" MaxLength="03" Style="text-transform: uppercase"></asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td class="field_input">
                                                <asp:TextBox ID="txtITName" runat="server" CssClass="mid" MaxLength="50"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="CV_ITName" runat="server" Display="None" ErrorMessage="ItemType Name is required!"
                                ...
                                <asp:Panel ID="pnlDisplay" runat="server">
                                    ...
                                    <cc1:Grid ID="gvittype" runat="server" CallbackMode="true" Serialize="true" FolderStyle="../GridStyles/premiere_blue"
                                        ...
                                        <Columns>
                                            <cc1:Column DataField="ITID" ReadOnly="true" HeaderText="ITID" runat="server" Visible="false" />
                                            <cc1:Column ID="Column1" DataField="ITCODE" HeaderText=" CODE" runat="server" Width="240">
                                                <FilterOptions>
                                            ...
                                            <cc1:Column DataField="ITNAME" HeaderText="NAME" runat="server" Width="240" SortOrder="Asc">
                                                <FilterOptions>
                                                    <cc1:FilterOption Type="NoFilter" />
                                                    <cc1:FilterOption Type="EqualTo" />
                                                    <cc1:FilterOption Type="Contains" />
                                            ...
                                            <cc1:Column DataField="ITDESCRIPTION" HeaderText="DESCRIPTION" runat="server" Width="280">
                                                <FilterOptions>
                                                    <cc1:FilterOption Type="NoFilter" />
                                                    <cc1:FilterOption Type="EqualTo" />
                                                    <cc1:FilterOption Type="Contains" />
                ...
                <script type="text/javascript">
                    ...
                    function performSearch() {
                        ...
                        gvittype.addFilterCriteria('ITCODE', OboutGridFilterCriteria.Contains, searchValue);
                        gvittype.addFilterCriteria('ITNAME', OboutGridFilterCriteria.Contains, searchValue);
                        gvittype.addFilterCriteria('ITDESCRIPTION', OboutGridFilterCriteria.Contains, searchValue);
