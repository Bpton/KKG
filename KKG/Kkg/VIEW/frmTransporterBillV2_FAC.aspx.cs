...
public partial class VIEW_frmTransporterBillV2_FAC : System.Web.UI.Page
{
    #region Page_Load
        ...
        if (!IsPostBack)
        {
            if (Request.QueryString["TYPE"] != "LGRREPORT")
            {
                ...
                if (Checker == "TRUE")
                {
                    ...
                    this.CalendarExtender1.Enabled = false;
                ...
                else
                {
                    ...
                    this.CalendarExtender1.Enabled = true;
            ...
            {
                // btnaddhide.Style["display"] = "none";
                this.tdSaveClose.Visible = false;
    ...
    protected void btnAddMenu_Click(object sender, EventArgs e)
    {
        ...
        /*int Flag1 = clsVoucher1.CheckDate(Session["USERID"].ToString(), Session["FINYEAR"].ToString(), "A");*/
        int Flag1 = clsVoucher1.CheckDate();
        if (Flag1 <= 0)
        {
            MessageBox1.ShowInfo("<b>'" + "Back Date Entry Is Being Locked" + "'</br></br><font color='gray'>Please Inform to administrator</font></b>", 45, 400);
            return;
        }
    ...
    protected void rdbtype_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            ClsTransporterBillV2_FAC transporterbill = new ClsTransporterBillV2_FAC();
    ...
    {
        ClsTransporterBillV2_FAC clstranspoter = new ClsTransporterBillV2_FAC();
    ...
    protected void ddlinvoice_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            ClsTransporterBillV2_FAC clstransporter = new ClsTransporterBillV2_FAC();
            DataTable dt = new DataTable();
            ...
            GetIsTransferToHo();
            Rcmcheck();
            if (gvtransporterAdd.Rows.Count > 0)
            {
    ...
    protected void LoadTransporterBill()
    {
        ...
        // }
        dt = transporterbill.BindTransporterbillall(this.ddlregion.SelectedValue.Trim(), this.txtFromDate.Text.Trim(), this.txtToDate.Text.Trim(), HttpContext.Current.Session["FINYEAR"].ToString().Trim());
        if (dt.Rows.Count > 0)
        {
    ...
    {
        ClsTransporterBillV2_FAC CLSTRANBILL = new ClsTransporterBillV2_FAC();
        DataTable DT = new DataTable();
    ...
    protected void btngridedit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Checker == "TRUE" && transporterbill.Getstatusforedit(this.hdntrnsID.Value.Trim()) == "0")
            {
                this.btnsubmitdiv.Visible = false;
                this.divbtnapprove.Visible = true;
                this.divbtnreject.Visible = true;
    ...
    protected void btnApprove_Click(object sender, EventArgs e)
    {
        ...
        int vda = clsVoucher.VOUCHER_DELETE_PREAPPROVED(Session["USERID"].ToString(), receivedID, IPAddress, this.ddldepot.SelectedValue.Trim());
    ...
    protected void gvtransporterbill_RowDataBound(object sender, GridRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == GridRowType.DataRow)
            {
                ...
                GridDataControlFieldCell cell5 = e.Row.Cells[9] as GridDataControlFieldCell;
    ...
    public void LoadTaxes()
    {
        ...
        DataTable dt = new DataTable();
        //if (Convert.ToDecimal(txtBillvalue.Text.Trim()) > 750)
        //{

        //    dt = transporterbill.BindGstPercentage(depot.Trim(), this.ddltransporter.SelectedValue.Trim(), Convert.ToDecimal(this.txttdsdeductablevalue.Text), Convert.ToString(this.ddlinvoice.SelectedValue), Convert.ToString(this.rdbtype.SelectedValue).Trim(), Convert.ToInt32(this.ddlfromstate.SelectedValue), Convert.ToInt32(this.ddltostate.SelectedValue));
        //}
        if (Convert.ToDecimal(txtBillvalue.Text.Trim()) > 750 || this.chkReversecharge.Checked == false)
        {
            string RCM = "Y";
            if (this.chkReversecharge.Checked == false)
            {
                RCM = "N";
            }
            dt = transporterbill.BindGstPercentage_New(depot.Trim(), this.ddltransporter.SelectedValue.Trim(), Convert.ToDecimal(this.txttdsdeductablevalue.Text), Convert.ToString(this.ddlinvoice.SelectedValue), Convert.ToString(this.rdbtype.SelectedValue).Trim(), Convert.ToInt32(this.ddlfromstate.SelectedValue), Convert.ToInt32(this.ddltostate.SelectedValue), RCM);
        }
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (AccEntryID != null)
            {
                ...
                upath = "frmRptInvoicePrint_FAC.aspx?Stnid=" + hdntrnsID.Value.Trim() + "&&TAG=TB&&MenuId=45";
    ...
    public void DateLock()
    {
        ...
        if (today1 >= new DateTime(startyear1, 04, 01) && today1 <= new DateTime(endyear1, 03, 31))
        {
            ...
            this.txtbilldate2.Text = DateTime.Now.ToString("dd/MM/yyyy").Replace('-', '/');
        ...
        else
        {
            ...
            this.txtbilldate2.Text = new DateTime(endyear1, 03, 31).ToString("dd/MM/yyyy").Replace('-', '/');
