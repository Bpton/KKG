<%@ Page Title="" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true" CodeFile="frmtpuvendorupload.aspx.cs" Inherits="VIEW_frmtpuvendorupload" %>
                                            ...
                                            <td class="field_input">
                                                <asp:DropDownList ID="ddlaccountgroup" Width="270" runat="server" data-placeholder="Select Group Name"
                                                 ...
                                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="* Required!"
                                                    ValidationGroup="ADD" Font-Bold="true" ForeColor="Red" ControlToValidate="ddlaccountgroup"
