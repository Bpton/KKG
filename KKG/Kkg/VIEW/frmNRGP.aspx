<%@ Page Title="" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true" CodeFile="frmNRGP.aspx.cs" Inherits="VIEW_frmNRGP" %>
                                ...
                                <asp:Panel ID="InputTable" runat="server">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0"class="form_container_td">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="135" class="innerfield_title">
                                                                            <asp:Label ID="lblTransportMode"  Width="100" Text="VENDOR" runat="server"></asp:Label>
                                                                        </td>
                                                                        <td width="50">
                                                                            <asp:DropDownList ID="ddlTransportMode" Width="180" runat="server" class="chosen-select"
                                                                                data-placeholder="Choose Transport Mode" AutoPostBack="true" OnSelectedIndexChanged="ddlTransportMode_SelectedIndexChanged">
                                                                                </asp:DropDownList>
                                                                        </td>
                                                        <td id="Td1" class="field_title" width="75" runat="server" style="display:none">
                                                            <asp:Label ID="Label7" runat="server" Text="Party Name"></asp:Label>
                                                        </td>
                                                        <td class="field_input" width="100" style="display:none">
                                                            <asp:TextBox ID="txtname" runat="server" Width="150" MaxLength="50" placeholder="Name"></asp:TextBox>
                                                        </td>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td class="field_input" width="100">
                                                            <asp:TextBox ID="txtlrgrno" runat="server" Width="150" MaxLength="50" placeholder="LR No"></asp:TextBox>
                                                        </td>
                                            ...
                                            <td class="field_input" colspan="9" >
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                                                        <tr>
                                                            ...
                                                            <td width="110" class="field_input">
                                                                <asp:DropDownList ID="ddlSuppliedItem" runat="server" class="chosen-select" data-placeholder="Select Supplied Item"
                                                                    AppendDataBoundItems="True" Width="150px" ValidationGroup="A" AutoPostBack="true"
                                                            ...
                                                            <td width="250" class="field_input">
                                                                <asp:DropDownList ID="ddlstorelocation" runat="server" Width="200" ValidationGroup="datecheckpodetail" 
                                                    ...
                                                    <tr>
                                                            ...
                                                            <td width="60" class="field_input">
                                                                <asp:TextBox ID="txtrate" runat="server" Width="60" onkeypress="return isNumberKeyWithDot(event);"
                                                                    ValidationGroup="datecheckpodetail"></asp:TextBox>
                                                                <span class="label_intro">
                                        ...
                                        <div class="gridcontent-inner">
                                                <fieldset>
                                                    <legend>NRGP PRODUCT DETAILS</legend>                                                    
                                                        <cc1:Grid ID="gvSaleOrder" runat="server" CallbackMode="true" Serialize="true" ShowFooter="true" ShowColumnsFooter="true"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <cc1:Column ID="Column21" DataField="STORELOCATIONNAME" HeaderText="STORE NAME" runat="server" Width="80">
                                                                  </cc1:Column>
                                                                ...
                                                                <cc1:Column ID="Column11" DataField="UOMNAME" HeaderText="UOM"
                                                                  ...
                                                                  <cc1:Column ID="Column5" DataField="RATE" HeaderText="RATE" runat="server" Width="80">
                                                                   ...
                                                                   <cc1:Column ID="Column19" DataField="AMOUNT" HeaderText="AMOUNT" runat="server" Width="70">
                                                                  </cc1:Column>
