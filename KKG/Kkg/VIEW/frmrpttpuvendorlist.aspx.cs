...
public partial class VIEW_frmrpttpuvendorlist : System.Web.UI.Page
{
    #region Page_Load
    ...
    public void LoadSUPLIEDITEM()
    {
        try
        {
            ...
            ddltype.DataSource = ClsProduct.BindSuplieditem();
    ...
    protected void BindGrid()
    {
        ...
        dtBindGrid = ClsProduct.BindTPUVendortList(this.ddltype.SelectedValue.Trim());
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "TpuVendor_"  + ".xls"));
            Response.Charset = "";
            ...
            hw.Write("<table><tr><td colspan=4><b>TpuVendor List</b></td></tr>");
