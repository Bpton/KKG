<%@ Page Title="" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true" CodeFile="frmSaleOrderFG.aspx.cs" Inherits="VIEW_frmSaleOrderFG" %>
                                ...
                                <asp:Panel ID="InputTable" runat="server">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                                        <tr>
                                            ...
                                            <tr>
							                    <td class="innerfield_title"><asp:CheckBox ID="chkactive" runat="server" Text=" "  /><asp:Label ID="Label13"  Text="ORDER CANCEL" runat="server"></asp:Label></td>
                                            </tr>
                                            </table>
                                             </blockquote>
                                                <fieldset>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="field_input">
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="CV_TPUNAME" runat="server" ControlToValidate="ddlgroup"
                                                                            InitialValue="0" SetFocusOnError="true" ErrorMessage="*" ForeColor="Red"
                                                                    ...
                                                                    <td class="field_input" width="220">
                                                                        <asp:DropDownList ID="ddldeliveryterms" runat="server" Width="220" Height="28px" ValidationGroup="POFooter"
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                                                        <tr>
                                                            ...
                                                            <td valign="top" width="310" class="field_input">
                                                                <asp:DropDownList ID="ddlProductName" runat="server" Width="300"                                                                     AutoPostBack="true" ValidationGroup="datecheckpodetail" OnSelectedIndexChanged="ddlProductName_SelectedIndexChanged"
                                                            ...
                                                            <td width="80" class="field_input">
                                                                <asp:DropDownList ID="ddlpackingsize" runat="server" Width="180" ValidationGroup="datecheckpodetail"
                                                    ...
                                                    <legend>SALE ORDER PRODUCT DETAILS</legend>                                                    
                                                        <cc1:Grid ID="gvSaleOrder" runat="server" CallbackMode="true" Serialize="true" ShowFooter="true" ShowColumnsFooter="true"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <cc1:Column ID="Column3" DataField="ORDERQTY" HeaderText="ORDER QTY" runat="server" Width="100" Wrap="true">
                                                                    <FilterOptions>
                                                                        <cc1:FilterOption Type="NoFilter" />
                                                                        <cc1:FilterOption Type="EqualTo" />
                                                                        <cc1:FilterOption Type="Contains" />
                                ...
                                <asp:Panel ID="pnlDisplay" runat="server">
                                    ...
                                    <div class="gridcontent">
                                        <cc1:Grid ID="gvsaleorderdetailsdetails" runat="server" CallbackMode="true" Serialize="true" AutoGenerateColumns="false"
                                            ...
                                            OnDeleteCommand="DeleteRecordSaleOrderDetails" FolderStyle="../GridStyles/premiere_blue"
                                            ...
                                            <cc1:Column ID="Column14" DataField="SALEORDERID" HeaderText="SALEORDERID" runat="server"
                                                ...
                                                <cc1:Column ID="Column8" DataField="CUSTOMERNAME" HeaderText="CUSTOMER NAME"
                                                ...
                                                <cc1:Column ID="Column21" DataField="TOTALVALUE" HeaderText="TOTAL VALUE"
