<%@ Page Title="" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true" CodeFile="frmRptRequisitionVsIssueQty.aspx.cs"
    Inherits="VIEW_frmRptRequisitionVsIssueQty" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">  
        ...
        function ValidateListBox_Depot(sender, args) {
            var options = document.getElementById("<%=ddlRequisitionDept.ClientID%>").options;
        ...
        function ValidateListBox_ddlbsegment(sender, args) {
            var options = document.getElementById("<%=ddlIssueDept.ClientID%>").options;
            for (var i = 0; i < options.length; i++) {
                if (options[i].selected == true) {
                    args.IsValid = true;
                    return;
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#ContentPlaceHolder1_ddlIssueDept').multiselect({
                includeSelectAllOption: true
            });
        });
        $(function () {
            $('#ContentPlaceHolder1_ddlRequisitionDept').multiselect({
                includeSelectAllOption: true
            });
        });
                                                ...
                                                <fieldset>
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            ...
                                                            <td class="field_title">
                                                                <asp:Label ID="lblPono" runat="server" Text="Requisition Department"></asp:Label>
                                                            </td>
                                                            <td width="23%">
                                                                <asp:ListBox ID="ddlRequisitionDept" runat="server" SelectionMode="Multiple" ValidationGroup="ADD"
                                                                    AppendDataBoundItems="True" TabIndex="4" Width="150px"></asp:ListBox>
                                                            </td>

                                                            <td class="field_title">
                                                                <asp:Label ID="Label2" runat="server" Text="Issue Department"></asp:Label>
                                                            </td>
                                                            <td width="23%">
                                                                <asp:ListBox ID="ddlIssueDept" runat="server" SelectionMode="Multiple" ValidationGroup="ADD"
                                                                    AppendDataBoundItems="True" TabIndex="4" Width="150px"></asp:ListBox>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="23%">
                                                             ...
                                                             <td>
                                                                 <asp:DropDownList ID="ddlIssueType" runat="server" AppendDataBoundItems="true" class="chosen-select"
                                                                    Style="width:100px;" data-placeholder="Choose a Type" ValidationGroup="datecheckrequision">
                                                                      <asp:ListItem Value="1">Issued</asp:ListItem>
                                                                      <asp:ListItem Value="0">Not Issued</asp:ListItem>
                                                                </asp:DropDownList>
                                                                 </td>
...
<%--                                     <div class="btn_24_blue" id="DivbtnExportDetails" runat="server">
                                ...
                                <ul id="search_box">
                                        ...
                                        <li>
                                            ...
                                            <ExportingSettings ExportColumnsFooter="true" ExportGroupFooter="true" ExportGroupHeader="true"
                                                FileName="Requisition Vs Issue Qty" ExportAllPages="true" ExportDetails="true" AppendTimeStamp="false" />
                                            <CssSettings CSSExportHeaderCellStyle="font-weight: bold;font-size: 10px;background-color: #DCE3E8;color: #0000FF;"
                                                CSSExportCellStyle="font-weight: normal;font-size: 10px;color: #0000;background-color: AFEEEE" />
                                                          <FilteringSettings InitialState="Visible" />
                                                            <Columns>
                                                            <cc1:Column DataField="REQDEPTNAME" HeaderText="Requisition Department" runat="server">
                                                                <FilterOptions>
                                                        ...
                                                        <cc1:FilterOption Type="StartsWith" />
                                                            ...
                                                            <cc1:Column DataField="CODE" HeaderText="Product Code" runat="server">
                                                            <FilterOptions>
                                                        <cc1:FilterOption Type="NoFilter" />
                                                        <cc1:FilterOption Type="Contains" />
                                                        <cc1:FilterOption Type="StartsWith" />
                                                            ...
                                                            <cc1:Column DataField="PRODUCTALIAS" HeaderText="Product name" runat="server">
                                                            <FilterOptions>
                                                        <cc1:FilterOption Type="NoFilter" />
                                                        <cc1:FilterOption Type="Contains" />
                                                        <cc1:FilterOption Type="StartsWith" />
                                                            ...
                                                            <cc1:Column DataField="Uom" HeaderText="Uom" runat="server">
                                                                <FilterOptions>
                                                        <cc1:FilterOption Type="NoFilter" />
                                                        <cc1:FilterOption Type="Contains" />
                                                        <cc1:FilterOption Type="StartsWith" />
                                                            ...
                                                            <cc1:Column DataField="REQUISITIONNO" HeaderText="Requisition no" runat="server">
                                                                <FilterOptions>
                                                        <cc1:FilterOption Type="NoFilter" />
                                                        <cc1:FilterOption Type="Contains" />
                                                        <cc1:FilterOption Type="StartsWith" />
                                                                ...
                                                                <cc1:Column DataField="REQUISITIONDATE" HeaderText="Requisition Date" runat="server">
                                                                <FilterOptions>
                                                        <cc1:FilterOption Type="NoFilter" />
                                                        <cc1:FilterOption Type="Contains" />
                                                        <cc1:FilterOption Type="StartsWith" />
                                                            ...
                                                            <cc1:Column DataField="RQTY" HeaderText="Requisition Qty" runat="server">
                                                                <FilterOptions>
                                                        <cc1:FilterOption Type="NoFilter" />
                                                        <cc1:FilterOption Type="Contains" />
                                                        <cc1:FilterOption Type="StartsWith" />
                                                            ...
                                                            <cc1:Column DataField="ISSUENO" HeaderText="Issue no" runat="server" >
                                                                <FilterOptions>
                                                        <cc1:FilterOption Type="NoFilter" />
                                                        <cc1:FilterOption Type="Contains" />
                                                        <cc1:FilterOption Type="StartsWith" />
                                                                  ...
                                                                  <cc1:Column DataField="ISSUEDATE" HeaderText="Issue Date" runat="server" >
                                                                <FilterOptions>
                                                        <cc1:FilterOption Type="NoFilter" />
                                                        <cc1:FilterOption Type="Contains" />
                                                        <cc1:FilterOption Type="StartsWith" />
                                                            ...
                                                            <cc1:Column DataField="ISSUEQTY" HeaderText="Issue Qty" runat="server" >
                                                                <FilterOptions>
                                                        <cc1:FilterOption Type="NoFilter" />
                                                        <cc1:FilterOption Type="Contains" />
                                                        <cc1:FilterOption Type="StartsWith" />
                                                            ...
                                                            <cc1:Column DataField="ISSUEDEPTNAME" HeaderText="Issue Department" runat="server" >
                                                                <FilterOptions>
                                                        <cc1:FilterOption Type="NoFilter" />
                                                        <cc1:FilterOption Type="Contains" />
                                                        <cc1:FilterOption Type="StartsWith" />
                                                            ...
                                                            <cc1:Column DataField="ISCLOSED" HeaderText="Is Close" runat="server">
                                                                <FilterOptions>
                                                        <cc1:FilterOption Type="NoFilter" />
                                                        <cc1:FilterOption Type="Contains" />
                                                        <cc1:FilterOption Type="StartsWith" />
                                                            ...
                                                            <cc1:Column DataField="PRORDERNUM" HeaderText="Production no for Auto Requisition" runat="server">
                                                                <FilterOptions>
                                                        <cc1:FilterOption Type="NoFilter" />
                                                        <cc1:FilterOption Type="Contains" />
                                                        <cc1:FilterOption Type="StartsWith" />
              ...
              <script type="text/javascript">
                ...
                function performSearch() {
                    ...
                    grdRptData.addFilterCriteria('PRODUCTALIAS', OboutGridFilterCriteria.Contains, searchValue);
                    grdRptData.addFilterCriteria('CODE', OboutGridFilterCriteria.Contains, searchValue);
                    grdRptData.executeFilter();
                    searchTimeout = null;
                    return false;
                }
            </script>
