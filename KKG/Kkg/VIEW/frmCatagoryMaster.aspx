<%@ Page Title="" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true" CodeFile="frmCatagoryMaster.aspx.cs" Inherits="VIEW_frmCatagoryMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
     <script type="text/javascript">
        function CHKHSNCode() {      
            var txtHSNCode1 = "ContentPlaceHolder1_txthsv";            
            ...
            <div id="contentarea">
                            ...
                            <div class="widget_content">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                                        <tr>
                                            <td width="120" class="field_title">
                                                <asp:Label ID="lblcatcode" Text="Code" runat="server"></asp:Label><span class="req">*</span>
                                            </td>
                                            <td class="field_input">
                                                <asp:TextBox ID="txtcatcode" runat="server" CssClass="mid" MaxLength="3" Style="text-transform: uppercase"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="CV_catcode" runat="server" Display="None" ErrorMessage="Category Code is required!"
                                        ...
                                        <tr>
                                            <td class="field_title">
                                                <asp:Label ID="lblcatname" Text="Name" runat="server"></asp:Label><span class="req">*</span>
                                            </td>
                                            <td class="field_input">
                                                <asp:TextBox ID="txtcatname" runat="server" CssClass="mid" MaxLength="50"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="CV_catname" runat="server" Display="None" ErrorMessage="Category Name is required!"
                                        ...
                                        <tr>
                                            <td class="field_title">
                                                <asp:Label ID="lblcatdescription" Text="Description" runat="server"></asp:Label><span class="req">*</span>
                                            </td>
                                            <td class="field_input">
                                        ...
                                        <tr>
                                            <td class="field_title"> <asp:Label ID="lblipsc" runat="server" Text="ITC"></asp:Label></td>
                                             <td class="field_input"> <asp:TextBox ID="txtipsc" runat="server" CssClass="mid" >   </asp:TextBox></td>

                                                
                                        </tr>
                                         <tr>
                                            <td class="field_title"> <asp:Label ID="lblhsv" runat="server" Text="HSN"></asp:Label><span class="req">*</td>
                                            <td class="field_input"> <asp:TextBox ID="txthsv" runat="server" CssClass="mid"  onchange="CHKHSNCode();"
                                                onkeypress="return isNumberKey(event);" MaxLength="8">   </asp:TextBox></td>
                                              <asp:RequiredFieldValidator ID="CV_HSN" runat="server" Display="None" ErrorMessage="Hsn is required!"
                                                            ControlToValidate="txthsv" ValidateEmptyText="false" OnServerValidate="CV_HSN_ServerValidate" SetFocusOnError="true"> </asp:RequiredFieldValidator>
                                        ...
                                        <tr >
                                            <td class="field_title"> <asp:Label ID="Label2" runat="server" Text="HSN CODE DESCRIPTION"></asp:Label></td>
                                            <td class="field_input" > <asp:TextBox ID="txthsncodedescript" runat="server" CssClass="mid" TextMode="MultiLine" Width="250px" >   </asp:TextBox></td>
                                ...
                                <asp:Panel ID="pnlDisplay" runat="server">
                                    ...
                                    <cc1:Grid ID="gvCATAGORY" runat="server" CallbackMode="true" Serialize="true" FolderStyle="../GridStyles/premiere_blue"
                                        ...
                                        <Columns>
                                            <cc1:Column DataField="CATID" ReadOnly="true" HeaderText="CATID" runat="server" Visible="false"  Width="240"/>
                                            <cc1:Column DataField="CATCODE" HeaderText="Category CODE" runat="server" Width="240">
                                                <FilterOptions>
                                            ...
                                            <cc1:Column  DataField="CATNAME" HeaderText="Category Name" runat="server"
                                                Width="406">
                                                <FilterOptions>
                                                    <cc1:FilterOption Type="NoFilter" />
                                                    <cc1:FilterOption Type="EqualTo" />
                                            ...
                                            <cc1:Column DataField="CATDESCRIPTION" HeaderText="DESCRIPTION" runat="server" Width="280">
                                                <FilterOptions>
                                                    <cc1:FilterOption Type="NoFilter" />
                                                    <cc1:FilterOption Type="EqualTo" />
                                                    <cc1:FilterOption Type="Contains" />
                                            ...
                                            <cc1:Column ID="Column2" DataField="HSN" HeaderText="HSN"  runat="server" Width="100"
                                               >
                                            </cc1:Column>
                ...
                <script type="text/javascript">
                    ...
                    function OnBeforeDelete(record) {
                        record.Error = '';
                        document.getElementById("<%=Hdn_Fld.ClientID %>").value = record.CATID;
                ...
                <script type="text/javascript">
                    ...
                    function performSearch() {
                        ...
                        gvCATAGORY.addFilterCriteria('CATCODE', OboutGridFilterCriteria.Contains, searchValue);
                        gvCATAGORY.addFilterCriteria('CATNAME', OboutGridFilterCriteria.Contains, searchValue);
                        gvCATAGORY.addFilterCriteria('CATDESCRIPTION', OboutGridFilterCriteria.Contains, searchValue);
              ...
              <%--  <script type="text/javascript">
                    ...
                    function populateEditControls(iRecordIndex) {
                        document.getElementById("<%=txtcatcode.ClientID%>").value = gvCATAGORY.Rows[iRecordIndex].Cells[1].Value;
                        document.getElementById("<%=txtcatname.ClientID%>").value = gvCATAGORY.Rows[iRecordIndex].Cells[2].Value;
                        document.getElementById("<%=txtDescription.ClientID%>").value = gvCATAGORY.Rows[iRecordIndex].Cells[3].Value;
                        var activevalue = gvCATAGORY.Rows[iRecordIndex].Cells[4].Value;
