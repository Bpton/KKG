<%@ Page Title="" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true"
    CodeFile="frmInvoiceMM_FAC.aspx.cs" Inherits="VIEW_frmInvoiceMM_FAC" %>
                                ...
                                <asp:Panel ID="pnlAdd" runat="server">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_container_td">
                                            ...
                                            <td class="field_input" style="padding-left: 10px">
                                                <fieldset>
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                        ...
                                                        <tr id="trRdaio" runat="server">
                                                            <td class="field_title">
                                                                <asp:Label ID="lblRadioBox" runat="server">Invoice Type</asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:RadioButtonList ID="rblInvoiceType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="rblInvoiceType_SelectedIndexChanged">
                                                                    <asp:ListItem Selected="True" Text="WITH ORDER" Value="Y" />
                                                                    <asp:ListItem Text="WITH OUT ORDER" Value="N" />
                                                                </asp:RadioButtonList>
                                                            </td>
                                                        </tr>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="90" class="field_title" id="lblSaleOrder" runat="server">
                                                <asp:Label ID="lblPO" Text="Sale Order" runat="server"></asp:Label>&nbsp;<span class="req">*</span>
                                            </td>
                                            <td class="field_input" width="210" id="tdSaleOrder" runat="server">
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td class="field_input" width="60">
                                                                ...
                                                                <span class="label_intro">
                                                                    <label>
                                                                        ORDER QTY</label></span>
                                                            </td>
                                                            <td class="field_input" width="90">
                                                                <asp:TextBox runat="server" ID="txtDespatchQty" Width="70" placeholder="Delivered Qty"
                                                                    Enabled="false"></asp:TextBox>
                                                                <span class="label_intro">
                                                                    <label>
                                                                        DELIVERED QTY</label></span>
                                                            </td>
                                                            <td class="field_input" width="90">
                                                            ...
                                                            <td valign="top" style="width: 50%; padding-right: 20px">
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="float: right;">
                                                                            <asp:TextBox runat="server" ID="txtRoundoff" AutoPostBack="true" placeholder="Round Off" BackColor="Transparent"
                                                                                Font-Bold="true" OnTextChanged="txtRoundoff_TextChanged" Style="text-align: right;"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="innerfield_title" style="padding-left: 20px; color: #1e69de;">
