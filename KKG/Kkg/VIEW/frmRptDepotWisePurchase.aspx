<%@ Page Title="" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true"
    CodeFile="frmRptDepotWisePurchase.aspx.cs" Inherits="VIEW_frmRptDepotWisePurchase" %>
                                            ...
                                            <td class="field_input" style="padding-left: 10px;">
                                                <div style="margin: 0 auto; width: 1250px;">
                                                    ...
                                                    <div id="DivMainContent" style="overflow: scroll;" onscroll="OnScrollDiv(this);">
                                                        <%--<asp:GridView ID="gvDepotwisePurchase" runat="server" Width="100%"
                                                            ShowHeader="true" GridLines="Horizontal"
                                                            RowStyle-Height="27px" FooterStyle-Height="27px" CssClass="zebra">
                                                        </asp:GridView>--%>

                                                        <asp:GridView ID="gvDepotwisePurchase" runat="server" 
                                                            AutoGenerateColumns="true" Width="100%" OnDataBound="OnDataBound" OnRowDataBound="gvDepotwisePurchase_OnRowDataBound"
                                                             RowStyle-Height="25px" FooterStyle-Height="27px" Visible="true"
                                                            ShowHeader="true" GridLines="Horizontal" CssClass="zebra" OnRowCommand="gvDepotwisePurchase_OnRowCommand">
                                                            <Columns>
