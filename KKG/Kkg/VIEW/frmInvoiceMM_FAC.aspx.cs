...
public partial class VIEW_frmInvoiceMM_FAC : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        this.trRdaio.Style["display"] = "";
        this.lblSaleOrder.Style["display"] = "";
        this.tdSaleOrder.Style["display"] = "";
        this.rblInvoiceType.SelectedValue = "Y";
    ...
    public void BindSaleOrder(string CustomerID)
    {
        clsSaleInvoiceMM clsInvc = new clsSaleInvoiceMM();
        DataSet ds = new DataSet();
        ds = clsInvc.BindSaleOrder(CustomerID);
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            this.ddlSaleOrder.DataSource = dtss;
            this.ddlSaleOrder.DataValueField = "SALEORDERID";
            this.ddlSaleOrder.DataTextField = "SALEORDERNO";
            this.ddlSaleOrder.DataBind();

            ViewState["BSID"] = ds.Tables[1].Rows[0]["BSID"].ToString();

            /*if (ds.Tables[0].Rows.Count == 1)
            {
                this.ddlSaleOrder.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["GROUPID"]).Trim();
    ...
    protected void ddlDistributor_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (this.ddlDistributor.SelectedValue != "0")
        {
            ...
            //this.BindWayBill();
            if (this.rblInvoiceType.SelectedValue == "Y")
            {
                this.BindSaleOrder(this.ddlDistributor.SelectedValue.Trim());
                //this.BindDeliveryAddress(this.ddlDistributor.SelectedValue.Trim());
            }
    ...
    protected void LoadOrderProduct()
    {
        ...
        {
            if (this.rblInvoiceType.SelectedValue == "N")
            {
                mode = "AllProduct";
            ...
            {
                dtOrderDetails = clsInvc.BindOrderProduct(mode, this.ddlSaleOrder.SelectedValue.Trim());
            }
        }
        else
        {
    ...
    protected void btnADDGrid_Click(object sender, EventArgs e)
    {
        ...
        if (this.hdnDespatchID.Value == "")
        {
            this.hdnbilltype.Value = this.rblInvoiceType.SelectedValue;
            if (this.hdnbilltype.Value == "N")
            {
                this.txtOrderQty.Text = "0";
                this.txtRemainingQty.Text = "0";
        ...
        if (deliveredqty > 0 && isService == "F")
        {
            ...
            if (this.hdnbilltype.Value == "Y")/*ORDER AND WITH OUT ORDER*/
                {
            ...
            //    }
            int numberOfRecords = dtInvoice.Select("SALEORDERID = '" + this.ddlSaleOrder.SelectedValue + "' AND PRODUCTID = '" + this.ddlProduct.SelectedValue + "'").Length;
        ...
        try
        {
            ...
            if (ObjDate == true)
            {
                ...
                else
                {
                    ...
                    billingType = this.rblInvoiceType.SelectedValue.ToString();
    ...
    protected void btngrdedit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //if (Convert.ToString(ViewState["Checker"]) == "FALSE")
            //{
            //    if (clsInvc.Getstatus(this.hdnDespatchID.Value.Trim()) == "1")
            //    {
            ...
            //}
            this.trRdaio.Style["display"] = "none";
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (Convert.ToString(ds.Tables[0].Rows[0]["BILLINGTYPE"]).Trim() == "Y")
                {
                    ...
                    dtEditOrderDetails = clsInvc.BindOrderProduct(mode, this.ddlSaleOrder.SelectedValue.Trim());
                ...
                {
                    this.lblSaleOrder.Style["display"] = "none";
                    this.tdSaleOrder.Style["display"] = "none";
