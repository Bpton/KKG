<%@ Page Title="" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master" AutoEventWireup="true" CodeFile="frmInvoiceMM_FG.aspx.cs" Inherits="VIEW_frmInvoiceMM_FG" %>
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="90" class="field_title">
                                                                <asp:Label ID="lblPO" Text="Sale Order" runat="server"></asp:Label>&nbsp;<span class="req">*</span>
                                                            </td>
                                                            <td class="field_input" width="210">
                                                                <asp:DropDownList ID="ddlSaleOrder" runat="server" class="chosen-select" data-placeholder="Select Sale Order"
                                                                    AppendDataBoundItems="True" AutoPostBack="true" Width="200px" ValidationGroup="Save"
                                                                    OnSelectedIndexChanged="ddlSaleOrder_SelectedIndexChanged">
                                                                </asp:DropDownList>
                                                                <%--<asp:RequiredFieldValidator ID="CV_ddlSaleOrder" runat="server" ControlToValidate="ddlSaleOrder"
                                                                    ValidateEmptyText="false" SetFocusOnError="true" ErrorMessage="*" ValidationGroup="Save"
                                                                    ForeColor="Red" InitialValue="0"></asp:RequiredFieldValidator>--%>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="field_input">
                                                                <asp:DropDownList ID="ddlWaybill" Width="200" runat="server" class="chosen-select"
                                                                    data-placeholder="Select E-Waybill" AppendDataBoundItems="True">
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td class="field_title">
                                                        ...
                                                        <tr>
                                                            <td class="field_title">
                                                                <asp:Label ID="Label1" Text="Shipping Address" runat="server"></asp:Label></td>
                                                            <td class="field_input" colspan="8">
                                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                    <tr>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td width="80" class="innerfield_title">
                                                                <asp:Label ID="lblPacksize" Text="Packsize" runat="server"></asp:Label>&nbsp;<span
                                                                    class="req">*</span>
                                                            </td>
                                                            <td class="field_input" width="70" colspan="3">
                                                                <asp:DropDownList ID="ddlPacksize" runat="server" class="chosen-select" data-placeholder="UOM"
                                                                    AppendDataBoundItems="True" Width="130" ValidationGroup="A" OnSelectedIndexChanged="ddlpackingsize_SelectedIndexChanged" AutoPostBack="true">
                                                                </asp:DropDownList>
                                                        ...
                                                        <tr>
                                                            <td class="field_title">
                                                                <asp:Label ID="Label3" Text="BatchNo" runat="server"></asp:Label>&nbsp;<span class="req">*</span></td>
                                                            <td class="field_input" colspan="7">
                                                                <asp:DropDownList ID="ddlbatchno" runat="server" Width="650px" CssClass="common-select" Height="24px" 
                                                                    AutoPostBack="true" AppendDataBoundItems="True" Style="font-family: 'Courier New', Courier, monospace"
                                                                    ValidationGroup="A" onselectedindexchanged="ddlbatchno_SelectedIndexChanged">
                                                        ...
                                                        <tr>
                                                            <td class="field_title" width="110">
                                                                <asp:Label ID="lblmrp" Text="Mrp" runat="server"></asp:Label>&nbsp;<span class="req">*</span></td>
                                                            <td class="field_input" width="50">
                                                                <asp:TextBox runat="server" ID="txtMRP" Width="50" placeholder="MRP" Enabled="false"></asp:TextBox>                                                                
                                                            </td>
                                                            <td class="field_title" width="110">
                                                                <asp:Label ID="lblrate" Text="RATE" runat="server"></asp:Label>&nbsp;<span class="req">*</span></td>
                                                            <td class="field_input" width="50">
                                                                <asp:TextBox runat="server" ID="txtBaseCost" Width="50" placeholder="RATE" Enabled="false"></asp:TextBox>
                                                            </td>

                                                            <td class="field_title">
                                                                <asp:Label ID="lblorderQty" Text="OrderQty" runat="server"></asp:Label>&nbsp;<span class="req">*</span></td>
                                                            <td class="field_input" width="60">
                                                                ...
                                                                <asp:TextBox runat="server" ID="txtOrderQty" Width="50" placeholder="Order Qty" Enabled="false"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="field_title">
                                                                <asp:Label ID="lbldespatch" Text="Delivered Qty" runat="server"></asp:Label>&nbsp;<span class="req">*</span></td>
                                                            <td class="field_input" width="90">
                                                                <asp:TextBox runat="server" ID="txtDespatchQty" Width="70" placeholder="Delivered Qty" Enabled="false"></asp:TextBox>
                                                            </td>
                                                            <td class="field_title">
                                                                <asp:Label ID="lblRemaining" Text="Remaining Qty" runat="server"></asp:Label>&nbsp;<span class="req">*</span></td>
                                                            <td class="field_input" width="90">
                                                                <asp:TextBox runat="server" ID="txtRemainingQty" Width="70" placeholder="Remaining Qty" Enabled="false"></asp:TextBox>
                                                            </td>
                                                            <td class="field_title">
                                                                <asp:Label ID="lblStockQty" Text="Stock Qty" runat="server"></asp:Label>&nbsp;<span class="req">*</span></td>
                                                            ...
                                                            <td class="field_title">
                                                                <asp:Label ID="lblinvoiceqty" Text="Invoice Qty" runat="server"></asp:Label>&nbsp;<span class="req">*</span>                                                            
                                                                <asp:TextBox runat="server" ID="txtDeliveredQtyPCS" Width="65" Text="0.00" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                                <asp:TextBox runat="server" ID="txtDeliveredQty" placeholder="CASE" ValidationGroup="A"
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorDeliveredQtyPCS" runat="server"
                                                                    ...
                                                                    ErrorMessage="Req" ValidationGroup="A" ForeColor="Red"></asp:RequiredFieldValidator>
                                                            ...
                                                            <td class="field_input" valign="top">
                                                                <asp:CheckBox ID="chkFree" runat="server" Text="&nbsp;&nbsp;Free Issue" TabIndex="1" Visible="false" />                                                                
                                                            </td>
                                                            <td>&nbsp;
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        ...
                                                                        <td style="float: right;">
                                                                            <asp:TextBox runat="server" ID="txttotalscheme" BackColor="Transparent" Font-Bold="true"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="float: right;">
                                                                            <asp:TextBox runat="server" ID="txtTotDisc" placeholder="Special&nbsp;Disc." Style="text-align: right;"
