<%@ Page Title="Margin Setup" Language="C#" MasterPageFile="~/VIEW/frmChildMaster.master"
    AutoEventWireup="true" CodeFile="frmTransporterBillV2.aspx.cs" Inherits="VIEW_frmTransporterBillV2" %>
                                                        ...
                                                        <td class="field_title" width="90">
                                                            ...
                                                            <td class="field_input" width="400">
                                                                <asp:RadioButtonList ID="rdbtype" runat="server" AutoPostBack="true" ForeColor="blue" BackColor="AliceBlue"
                                                                    ...
                                                                    <asp:ListItem Text="TPU Purchase(Inward)" Value="STKDES" />
                                                            ...
                                                            <td id="tdddlinvoice" runat="server" class="field_input" width="200" style="padding-bottom: 24px;">
                                                             ...
                                                             <td id="Td2" runat="server" width="60" class="field_title" style="padding-bottom: 24px;">
                                                                Customer<span class="req">*</span>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtCustomerNameFromInovice" runat="server" Enabled="false" ></asp:TextBox>
                                                            </td>

                                                             <td id="Td3" runat="server" width="30" class="field_title" style="padding-bottom: 24px;">
                                                                Gst No
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtPartyGstNo" runat="server" Enabled="false" ></asp:TextBox>
                                                            </td>

                                                             <td id="Td4" runat="server" width="30" class="field_title" style="padding-bottom: 24px;">
                                                                Invoice Amnt
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtInvAmnt" runat="server" Enabled="false" ></asp:TextBox>
                                                            </td>
                                                            </tr>
                                                        <tr>
                                                             <td class="field_title" width="90">
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            ...
                                                            <td class="field_input" width="110">
                                                                <asp:TextBox ID="Txtbillno" runat="server" Width="100" ValidationGroup="ADD"></asp:TextBox>
                                                            ...
                                                            <td class="field_input" width="80">
                                                                <asp:TextBox ID="txttdsdeductablevalue" runat="server" ValidationGroup="ADD" Width="70"
                                                                    onkeypress="return isNumberKeyWithDot(event);" MaxLength="10" Enabled="false"
                                                         ...
                                                         <td width="80" class="field_title" style="padding-bottom: 15px; display:none">
                                                           ...
                                                           <td width="30" class="field_title" style="padding-bottom: 15px;">
                                                            ...
                                                            <td class="field_title" width="90" style="padding-bottom: 15px;">
                                                                <asp:Label ID="Label7" Text="Gross Wt.(KG)" runat="server"></asp:Label>
                                                            </td>
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="form_container_td">
                                                        ...
                                                        <tr>
                                                            <td width="120" class="field_title">
                                                                <asp:Label ID="Label13" Text="Transfer To HO" runat="server" ForeColor="#0066FF" Visible="false"></asp:Label><br /><br />
                                                            ...
                                                            <asp:CheckBox ID="chktransferHO" runat="server" Enabled="true"  Visible="false"/><br />
                                                             <asp:CheckBox ID="chkReversecharge" runat="server" OnCheckedChanged="chkReversecharge_OnCheckedChanged" AutoPostBack="true" BackColor="#ff9999"  />
                                                             </td>
                                    ...
                                    <div class="gridcontent">
                                        <cc1:Grid ID="gvtransporterbill" runat="server" CallbackMode="false" Serialize="true" PageSize="500"
                                            ...
                                            <Columns>
                                                ...
                                                <cc1:Column ID="Column11" HeaderText="SL" AllowEdit="false" AllowDelete="false" Width="60">
                                                    <TemplateSettings TemplateId="tempsl" />
                                                </cc1:Column>
                                                 <cc1:Column ID="Column244" DataField="DEPOTNAME" HeaderText="DEPOT" Width="80"
                                                    runat="server" Wrap="true">
                                                    
                                                </cc1:Column>
                                                <cc1:Column ID="Column2" DataField="TRANSPORTERBILLNO" HeaderText="TRANSPORTER VOUCHER NO." Width="210"
                                                    runat="server" Wrap="true">
                                                </cc1:Column>
                                                  <cc1:Column ID="Column29" DataField="BILLNO" HeaderText="BILL NO." Width="210"
                                                    runat="server" Wrap="true">
                                                </cc1:Column>

                                                <cc1:Column ID="Column3" DataField="TRANSPORTERBILLDATE" HeaderText="TRANSPORTER ENTRY DATE" Width="100"
                                                    runat="server" Wrap="true">
                                                    <FilterOptions>
                                                 ...
                                                 <cc1:Column ID="Column333" DataField="BILLDATE" HeaderText="BILL DATE" Width="100"
                                                    runat="server" Wrap="true">
                                                    <FilterOptions>
                                                        <cc1:FilterOption Type="NoFilter" />
                                                        <cc1:FilterOption Type="EqualTo" />
                                                ...
                                                <cc1:Column ID="Column9" DataField="TOTALSERVICETAX" HeaderText="GST(INPUT)" Width="100"  HeaderAlign="right" Align="right"
                                                    runat="server" Wrap="true"  >
                                                    <FilterOptions>
                                                        <cc1:FilterOption Type="NoFilter" />
                                                        <cc1:FilterOption Type="EqualTo" />
         ...
         function calculation() {
            ...
            <script type="text/javascript">
                ...
                function CallServerMethod(oLink) {
                    ...
                    document.getElementById("<%=hdnStatus.ClientID %>").value = gvtransporterbill.Rows[iRecordIndex].Cells[17].Value;
