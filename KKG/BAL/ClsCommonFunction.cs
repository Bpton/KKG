...
namespace BAL
{
    public class ClsCommonFunction
    {
        ...
        #region Load Ledger For Grn Approval For KKGPage
        public DataTable LoadGRNLedger()
        {
            string sql = "EXEC USP_LEGERGRN_BIND";
            DataTable dt = db.GetData(sql);
            return dt;
        }
        ...
        //    return dt;
        //}
        //public List<USP_GET_DEPOT_BASE_ON_USER_Result> BindFromDepo_edmx(string Userid)
        //{
        //    List<USP_GET_DEPOT_BASE_ON_USER_Result> res = PrayaasDB.USP_GET_DEPOT_BASE_ON_USER(Userid).ToList();
        //    return res;
        //}
