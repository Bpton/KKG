...
namespace BAL
{
    public class ClsFactoryStockTransfer
    {
        DBUtils db = new DBUtils();
        KKGEntities KKgEnT = new KKGEntities();
        ...
        public string HSNCode(string ProductID)
        {
            ...
            string sql = string.Empty;
            sql = " SELECT ISNULL(B.HSNCODE,'') AS HSNCODE FROM M_PRODUCT A " +
                  " INNER JOIN M_HSNCODE B ON A.CATID=B.CATID " +
                  " AND A.ID='" + ProductID + "'";
        ...
        //    sql = "EXEC USP_BIND_TODEPOT '"+ DEPOID + "'";
        //    DataTable dt = new DataTable();
        //    dt = db.GetData(sql);
        //    return dt;
        //}
        ...
        //{
        //    string sql = " SELECT CATID,CASE WHEN HSN IS NULL THEN CATNAME WHEN HSN='' THEN CATNAME ELSE CATNAME+'  ('+HSN+')' END AS CATNAME,ISNULL(HSN,'') AS HSN" +
        //                 " FROM M_CATEGORY " +
        //                 " WHERE HSN <> '33049940' AND HSN <> '' AND HSN IS NOT NULL" +
        //                 " ORDER BY CATNAME";
        //    DataTable dt = new DataTable();
        //    dt = db.GetData(sql);
        //    return dt;
        ...
        //{
        //    string sql = string.Empty;
        //    sql = "EXEC USP_BIND_PRODUCT '" + DepotID + "'";
        //    DataTable dt = new DataTable();
        //    dt = db.GetData(sql);
        //    return dt;
        //}
        ...
        //{
        //    string sql = string.Empty;
        //    sql = "EXEC USP_BIND_PRODUCT_CATEGORYWISE '" + Category + "','" + DepotID + "'";
        //    DataTable dt = new DataTable();
        //    dt = db.GetData(sql);
        //    return dt;
        //}
        ...
        {
            string sql = string.Empty;
            sql = "EXEC USP_BATCHWISE_FACTORY_STOCK '" + depotid + "','" + pid + "','" + TOPACKSIZEID + "','" + batchno + "'";
            DataTable dt = new DataTable();
            dt = db.GetData(sql);
            return dt;
        }
        ...
        {
            //string sql = "SELECT PSID,PSNAME FROM  Vw_PACKSIZE WHERE SEQUENCENO NOT IN (2,4) ORDER BY SEQUENCENO";
        ...
        //{
        //    string sql = "EXEC USP_BATCHWISE_FACTORY_STOCK '" + DepotID + "','" + ProductID + "','" + PacksizeID + "','" + BatchNo + "'";
        //    DataTable dt = new DataTable();
        //    dt = db.GetData(sql);
        //    return dt;
        //}
        ...
        public string GetSyncStatus(string DespatchID)
        {
            string Sql = " IF  EXISTS(SELECT 1 FROM [T_STOCKDESPATCH_HEADER] WHERE STOCKDESPATCHID='" + DespatchID + "' AND SYNCTAG='Y') BEGIN " +
                         " SELECT '1'   END  ELSE   BEGIN	SELECT '0'   END ";
            return ((string)db.GetSingleValue(Sql));
        }
        ...
        //{
        //    string sql = string.Empty;
        //    sql = "EXEC USP_DISPATCH_SEARCH '" + fromdate + "','" + todate + "','" + finyear + "','" + CheckerFlag + "','" + UserID + "','" + depotid + "'";
        //    DataTable dt = new DataTable();
        //    dt = db.GetData(sql);
        //    return dt;
        //}
        ...
        public string InsertFactoryDespatch(string hdnvalue, string despatchDate, string tpuid, string tpuname,
                                             ...
                                             string CountryID, string CountryName, string AllocationID, string AllocationNo,
                                             string InvoiceType, string ShippingAdd, string DeliveryDate, string ModuleID, string entryfrom, string EntryType)
        {
            string flag = "";
            ...
            try
            {
                string sqlprocDespatch = " EXEC [USP_FACTORY_DESPATCH_INSERT_UPDATE] '" + hdnvalue + "','" + flag + "','" + despatchDate + "','" + tpuid + "','" + tpuname + "','" + wayBillNo + "'," +
                                         ...
                                         " '" + AllocationID + "','" + AllocationNo + "','" + InvoiceType + "','" + ShippingAdd + "','" + DeliveryDate + "','" + ModuleID + "','" + entryfrom + "','" + EntryType + "'";
        ...
        {
            int delflag = 0;
            string sqldeleteStockTransfer = "EXEC [SP_STOCK_FACTORY_DESPATCH_DELETE] '" + DispatchID + "'";
        ...
        {
            DataSet ds = new DataSet();
            string sql = "EXEC USP_FACTORY_DESPATCH_DETAILS '" + DispatchID + "'";
            ds = db.GetDataInDataSet(sql);
        ...
        {
            string Flag = "";
            string sql = "SELECT ISVERIFIED FROM T_STOCKDESPATCH_HEADER WHERE STOCKDESPATCHID = '" + SaleOrderID + "' ";
        ...
        public List<USP_BIND_TODEPOT_Result> BindToDepo_edmx(string Depotid)
        {
            List<USP_BIND_TODEPOT_Result> res = KKgEnT.USP_BIND_TODEPOT(Depotid).ToList();
            return res;
        }
        //public List<UPDG_BINDWAYBILL_Result> Bindway`````bill(string depoid,string transferid)
        //{
        //    List<UPDG_BINDWAYBILL_Result> res = KKgEnT.UPDG_BINDWAYBILL(depoid, transferid).ToList();
        //    return res;
        //}

        public List<USP_FETCH_RECENT_TXN_TRANSPORTER_FAC_Result> BindRecentTxnTransporter_edmx(string FactoryID, string ToDepotID, string FinYear, string ModuleID)
        {
            List<USP_FETCH_RECENT_TXN_TRANSPORTER_FAC_Result> res = KKgEnT.USP_FETCH_RECENT_TXN_TRANSPORTER_FAC(FactoryID, ToDepotID, FinYear, ModuleID).ToList();
            return res;
        }
        //public List<USP_BIND_PACKSIZEFAC_Result> Bindpacksizefac()
        //{
        //    List<USP_BIND_PACKSIZEFAC_Result> res = KKgEnT.USP_BIND_PACKSIZEFAC().ToList();
        //    return res;
        //}
        //public List<USP_BINDTRANSPORTER_FAC_Result> BindTransporter(string menuid)
        //{
        //    List<USP_BINDTRANSPORTER_FAC_Result> res = KKgEnT.USP_BINDTRANSPORTER_FAC(menuid).ToList();
        //    return res;
        //}
        public List<USP_GET_TRANSPORTER_BASED_ON_DEPOT_Result> BindFactoryTransporter_edmx(string Depotid, string Transporteid)
        {
            List<USP_GET_TRANSPORTER_BASED_ON_DEPOT_Result> res = KKgEnT.USP_GET_TRANSPORTER_BASED_ON_DEPOT(Depotid, Transporteid).ToList();
            return res;
        }

        //public List<USP_BIND_CATEGORY_Result> BindCategory_edmx(string Condition)
        //{
        //    List<USP_BIND_CATEGORY_Result> res = KKgEnT.USP_BIND_CATEGORY(Condition).ToList();
        //    return res;
        //}

        //public List<USP_BIND_PRODUCT_FAC_Result> BindProduct_edmx(string Depotid, string Type)
        //{
        //    List<USP_BIND_PRODUCT_FAC_Result> res = KKgEnT.USP_BIND_PRODUCT_FAC(Depotid, Type).ToList();
        //    return res;
        //}

        //public List<USP_BIND_PRODUCT_CATEGORYWISE_Result> BindCategoryProduct_edmx(string Depotid, string Type)
        //{
        //    List<USP_BIND_PRODUCT_CATEGORYWISE_Result> res = KKgEnT.USP_BIND_PRODUCT_CATEGORYWISE(Depotid, Type).ToList();
        //    return res;
        //}

        //public List<USP_BATCHWISE_FACTORY_STOCK_Result> BindBatchDetails_edmx(string Depotid, string ProductID, string PacksizeID, string BatchNo)
        //{
        //    List<USP_BATCHWISE_FACTORY_STOCK_Result> res = KKgEnT.USP_BATCHWISE_FACTORY_STOCK(Depotid, ProductID, PacksizeID, BatchNo, 0, "113BD8D6-E5DC-4164-BEE7-02A16F97ABCC").ToList();
        //    return res;
        //}
        //public List<USP_BINDPOLICYNO_Result> Bindpolicyno(string companys)
        //{
        //    List<USP_BINDPOLICYNO_Result> res = KKgEnT.USP_BINDPOLICYNO(companys).ToList();
        //    return res;
        //}
        //public DispatchAmtPcs_Calculation DispatchAmtPcs(string ProductID, string FromPacksize, decimal DispatchQty, decimal Rate, decimal Assesment)
        //{
        //    var command = KKgEnT.Database.Connection.CreateCommand();
        //    command.CommandText = "[dbo].[USP_CALCULATE_AMT_IN_PCS_FAC]";
        //    command.CommandType = CommandType.StoredProcedure;
        //    command.Parameters.Add(new SqlParameter("@p_PRODUCTID", ProductID));
        //    command.Parameters.Add(new SqlParameter("@p_FROMPACKSIZEID", FromPacksize));
        //    command.Parameters.Add(new SqlParameter("@P_QTY", DispatchQty));
        //    command.Parameters.Add(new SqlParameter("@p_RATE", Rate));
        //    command.Parameters.Add(new SqlParameter("@p_ASSESMENTPERCENTAGE", Assesment));
        //    ObjectParameter[] param1 = new ObjectParameter[1];
        //    KKgEnT.Database.Connection.Open();
        //    var reader = command.ExecuteReader();
        //    List<Assesment> _listAssesment = ((IObjectContextAdapter)KKgEnT).ObjectContext.Translate<Assesment>(reader).ToList();
        //    reader.NextResult();

        //    List<QtyPcs> _listQtyPcs = ((IObjectContextAdapter)KKgEnT).ObjectContext.Translate<QtyPcs>(reader).ToList();
        //    reader.NextResult();

        //    List<NetWeight> _listntweight = ((IObjectContextAdapter)KKgEnT).ObjectContext.Translate<NetWeight>(reader).ToList();
        //    reader.NextResult();

        //    List<GrossWeight> _listgrossweight = ((IObjectContextAdapter)KKgEnT).ObjectContext.Translate<GrossWeight>(reader).ToList();
        //    reader.NextResult();

        //    List<Hsn> _listHsn = ((IObjectContextAdapter)KKgEnT).ObjectContext.Translate<Hsn>(reader).ToList();            

        //    DispatchAmtPcs_Calculation domainentity = new DispatchAmtPcs_Calculation();
        //    domainentity.ASSESMENT = _listAssesment;
        //    domainentity.QTYINPCS = _listQtyPcs;
        //    domainentity.NETWEIGHT = _listntweight;
        //    domainentity.GROSSWEIGHT = _listgrossweight;
        //    domainentity.HSNCODE = _listHsn;
        //    KKgEnT.Database.Connection.Close();
        //    return domainentity;
        //}

        //public List<USP_DISPATCH_SEARCH_Result> BindFactoryDispatch_edmx(string fromdate, string todate, string finyear, string CheckerFlag, string UserID, string depotid)
        //{
        //    List<USP_DISPATCH_SEARCH_Result> res = KKgEnT.USP_DISPATCH_SEARCH(fromdate, todate, finyear, CheckerFlag, UserID, depotid).ToList();
        //    return res;
        //}
        ...
        //public DataTable BindFactoryTransporter(string FactoryID)
        //public DataTable BindRecentTxnTransporter(string FactoryID, string ToDepotID, string FinYear, string ModuleID)
        public DataTable DeliveryDay(string DepotID, string ToDepotid, string InvoiceDate)
        {
            string sql = " EXEC [USP_CHECK_DELIVERY_DATE]'" + DepotID + "','" + ToDepotid + "','" + InvoiceDate + "'";
            DataTable dt = new DataTable();
            dt = db.GetData(sql);
            return dt;
        }
