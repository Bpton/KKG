...
namespace BAL
{
    public class ClsInstructionSheet_FAC
    {
        ...
        {
            string sql = "EXEC USP_EXPORT_SALEORDER_DETAILS_FAC '" + CountryID + "'";
            DataTable dt = new DataTable();
            dt = db.GetData(sql);
            return dt;
        }
        ...
        {
            string sql = " SELECT A.BRID,A.BRPREFIX AS BRNAME FROM M_BRANCH AS A " +
                                                ...
                                                string TransporterID, string TransporterName, string DespatchDate)
        {
            ...
            try
            {
                string sqlprocinstruction = " EXEC [CRUD_TPU_INSTRUCTIONHEADER_FAC] '" + hdnvalue + "','" + flag + "','" + hdnvalue + "','" + createdby + "','" + finyear + "'," +
        ...
        {
            int e = 0;
            string sql = " EXEC CRUD_TPU_PACKINGLIST_FAC '" + AllocationID + "','" + TPUID + "','" + xml + "'";
            e = db.HandleData(sql);
            return e;
        }
    }
