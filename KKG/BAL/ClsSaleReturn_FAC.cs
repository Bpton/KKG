...
namespace BAL
{
    public class ClsSaleReturn_FAC
    {
        ...
        public DataTable BindGroup(string BSID, string UserID, string CheckerFlag)/*INLINE TO SP CONVERT FOR KKG BY P.BASU ON 05-02-2021*/
        {
            string sql = string.Empty;
            DataTable dt = new DataTable();
            try
            {
                ...
                sql = "USP_BIND_GROUP_V2 '" + BSID + "','" + UserID + "','" + CheckerFlag + "' ";
                dt = db.GetData(sql);
        ...
        public DataTable BindBusinessegment()
        {
            ...
            try
            {
                sql = "select BSID, BSNAME from M_BUSINESSSEGMENT order by BSNAME";
                dt = db.GetData(sql);
            }
            catch (Exception ex)
            {
        ...
        public DataTable BindDepotCustomer(string bsID, string groupid, string DEPOTID, string SALERETURNID)
        {
            ...
            try
            {
                sql = "EXEC[Usp_bind_customer_groupwise_v2] '" + bsID + "','" + groupid + "','" + DEPOTID + "','" + SALERETURNID + "'";
                dt = db.GetData(sql);
            }
            catch(Exception EX)
            {
        ...
        {
            string Sql = "  IF  EXISTS(SELECT 1 FROM [T_SALERETURN_HEADER_MM] WHERE SALERETURNID ='" + SALERETURNID + "'  AND ISVERIFIED='Y' ) BEGIN " +
        ...
        public DataTable BindSaleReturn(string fromdate, string todate, string finyear, string BSID, string depotid, string CheckerFlag, string UserID)
        {
            ...
            sql = " EXEC USP_SEARCH_RETURNINVOICE_MM '" + fromdate + "','" + todate + "','" + finyear + "','" + BSID + "','" + depotid + "','" + CheckerFlag + "','" + UserID + "'";
            DataTable dt = new DataTable();
            dt = db.GetData(sql);
            return dt;
        }
        ...
        public DataSet BindInvoiceProductDetails(string InvoiceID)
        {
            ...
            try
            {
                ...
                sql = " EXEC USP_INVOICE_DETAILS_FAC '" + InvoiceID + "'";
                ds = db.GetDataInDataSet(sql);
        ...
        public DataTable BindTcsDetails(string InvoiceID)
        {
            string sql = string.Empty;
            DataTable dt = new DataTable();
            try
            {
                //sql = " EXEC USP_SALEINVOICEQTY_BASEDONPRODUCT_ERP '" + InvoiceID + "'";
                sql = " EXEC usp_tcs_checking '" + InvoiceID + "'";
                dt = db.GetData(sql);
        ...
        public DataTable BindStoreDetails1(string userid)
        {
            string sql = string.Empty;
            DataTable dt = new DataTable();
            try
            {
                //sql = " EXEC USP_SALEINVOICEQTY_BASEDONPRODUCT_ERP '" + InvoiceID + "'";
                sql = " EXEC usp_storelocation_bind '" + userid + "'";
                dt = db.GetData(sql);
        ...
        public DataTable BindStoreLOCATION()
        {
            ...
            {
                //sql = " EXEC USP_SALEINVOICEQTY_BASEDONPRODUCT_ERP '" + InvoiceID + "'";
                sql = " SELECT ID, NAME FROM M_STORELOCATION ";
                dt = db.GetData(sql);
        ...
        public DataTable BindDistributorInvoice(string DistID, string FromDate, string ToDate,string DepotId)/*ININE TO SP CONVERT BY P.BASU ON 05-02-2021*/
        {
            string sql = string.Empty;
            DataTable dt = new DataTable();
            try
            {
                sql = "USP_BIND_DISTRIBUTOR_WISE_INVOCIE_V2 '" + DistID + "','" + FromDate + "','" + ToDate + "','" + DepotId + "'";
                dt = db.GetData(sql);
            }
            catch (Exception ex)
            {
        ...
        {
            DataSet ds = new DataSet();
            string sql = "EXEC USP_SALE_RETURN_DETAILS_MM '" + SALERETURNID + "'";
            ds = db.GetDataInDataSet(sql);
        ...
        public string InsertReturnInvoiceDetails(string ReturnDate, string Customerid, string Customername,
                                                    ...
                                                    string xmlReturnInvoiceDetails, string xmlTax,string hdnvalue, string InvoiceType, decimal txttcsamt, decimal txttcspercent, decimal txttcs, decimal txttcsnet, string BSID, string BSNAME, string storeid, string ModuleID
                                                 )
        {
            ...
            if (hdnvalue == "")
            {
                ...
                try
                {
                    string sqlprocInvoice = " EXEC [USP_SALE_RETURNINVOICE_INSERT_UPDATE_MM] '','" + flag + "','" + ReturnDate + "'," +
                                            ...
                                            " '" + xmlReturnInvoiceDetails + "','" + xmlTax + "','" + InvoiceType + "', '" + txttcsamt + "','" + txttcspercent + "','" + txttcs + "','" + txttcsnet + "','" + BSID + "','" + BSNAME + "','" + storeid + "','" + ModuleID + "'";
        ...
        public string InvoiceDelete(string InvoiceID)
        {
            ...
            string sqldeleteStockDespatch = "EXEC [USP_SALE_RETURN_DELETE_MM] '" + InvoiceID + "'";
        ...
        public decimal GetHSNTaxOnEdit(string InvoiceID, string TaxID, string ProductID, string BatchNo)
        {
            ...
            sql = " SELECT ISNULL(TAXPERCENTAGE,0) " +
                  " FROM T_MM_SALEINVOICE_ITEMWISE_TAX " +
        ...
        public decimal GetHSNTaxOnEdit_Return(string InvoiceID, string TaxID, string ProductID, string BatchNo)
        {
            decimal ProductWiseTax = 0;
            string sql = string.Empty;
            sql = " SELECT ISNULL(TAXPERCENTAGE,0) " +
                  " FROM T_SALERETURN_ITEMWISE_TAX_MM " +
